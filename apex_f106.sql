...
prompt  APPLICATION 106 - DC/COMERCIAL
--
-- Application Export:
--   Application:     106
--   Name:            DC/COMERCIAL
...
wwv_flow_api.create_flow(
  ...
  p_name  => nvl(wwv_flow_application_install.get_application_name,'DC/COMERCIAL'),
  p_alias => nvl(wwv_flow_application_install.get_application_alias,'F_112106'),
  ...
  p_authentication_id=> 12528062492846051 + wwv_flow_api.g_id_offset,
  p_logout_url=> '',
  ...
  p_restrict_to_user_list=> 'ssalgueiro, jcabrera, rtorres, dbarrios, mflores, vvallejos, anegri',
  ...
  p_last_upd_yyyymmddhh24miss=> '20150520125831',
  p_ui_type_name => null,
...
wwv_flow_api.create_user_interface (
  p_id => 12527838937846050 + wwv_flow_api.g_id_offset
...
wwv_flow_api.create_plugin_setting (
  p_id => 12516945475846029 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
...
wwv_flow_api.create_icon_bar_item(
  p_id => 12527956156846051 + wwv_flow_api.g_id_offset,
  p_flow_id => wwv_flow.g_flow_id,
  p_icon_sequence=> 200,
  p_icon_image => '',
...
wwv_flow_api.create_tab (
  p_id=> 12529443849846062 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_tab_set=> 'TS1',
  p_tab_sequence=> 10,
  p_tab_name=> 'T_INICIO',
...
wwv_flow_api.create_page (
  p_flow_id => wwv_flow.g_flow_id
 ,p_id => 1
 ,p_user_interface_id => 12527838937846050 + wwv_flow_api.g_id_offset
 ,p_tab_set => 'TS1'
 ,p_name => 'Inicio'
 ,p_step_title => 'Inicio'
...
wwv_flow_api.create_page_plug (
  p_id=> 12529843971846082 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1,
  p_plug_name=> 'Navegación',
  p_region_name=>'',
  p_escape_on_http_output=>'N',
  p_plug_template=> 12521457267846039+ wwv_flow_api.g_id_offset,
  ...
  p_plug_source=> s,
  p_plug_source_type=> 12529567938846062 + wwv_flow_api.g_id_offset,
  p_list_template_id=> 12525266901846045+ wwv_flow_api.g_id_offset,
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 12530047913846088 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1,
  p_plug_name=> 'Rutas de Navegación',
  p_region_name=>'',
  p_escape_on_http_output=>'N',
  p_plug_template=> 12519442038846035+ wwv_flow_api.g_id_offset,
  p_plug_display_sequence=> 10,
  p_plug_new_grid         => false,
  p_plug_new_grid_row     => true,
  p_plug_new_grid_column  => true,
  ...
  p_plug_item_display_point=> 'ABOVE',
  p_plug_source=> s,
  p_plug_source_type=> 'M'|| to_char(12529142092846058 + wwv_flow_api.g_id_offset),
  p_menu_template_id=> 12527141111846047+ wwv_flow_api.g_id_offset,
  p_plug_query_row_template=> 1,
  p_plug_query_headings_type=> 'COLON_DELMITED_LIST',
  p_plug_query_row_count_max => 500,
  p_plug_display_condition_type => '',
...
wwv_flow_api.create_page (
 ...
 ,p_step_title => 'Reporte Ventas'
 ,p_step_sub_title => 'Reporte Ventas'
 ,p_step_sub_title_type => 'TEXT_WITH_SUBSTITUTIONS'
 ,p_include_apex_css_js_yn => 'Y'
 ,p_autocomplete_on_off => 'ON'
 ,p_page_is_public_y_n => 'N'
...
'No help is available for this page.'
 ,p_last_updated_by => 'DBARRIOS'
 ,p_last_upd_yyyymmddhh24miss => '20150105150553'
  );
null;
...
declare
  ...
  l_length number := 1;
begin
s:=s||'SELECT validacion.f_local1@bdtotus1(D2.D2_FILIAL) FILIAL,'||unistr('\000a')||
...
'FROM VALIDACION.SD2010@bdtotus1 D2,'||unistr('\000a')||
'     VALIDACION.SA1010@bdtotus1 A1';

s:=s||''||unistr('\000a')||
'WHERE D2.D2_CLIENTE = A1.A1_COD'||unistr('\000a')||
'AND D2.D2_LOJA = ''MI'''||unistr('\000a')||
'AND D2.D2_ESPECIE = ''NF'''||unistr('\000a')||
'AND D2.D_E_L_E_T_ = '' '''||unistr('\000a')||
'AND D2.D2_EMISSAO >= ''20141216'''||unistr('\000a')||
'AND D2.D2_EMISSAO <= ''20141231'''||unistr('\000a')||
'ORDER BY D2.D2_FILIAL, D2.D2_EMISSAO';

wwv_flow_api.create_report_region (
  p_id=> 3843524370404537 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 4,
  p_name=> 'Report 1',
  p_region_name=>'',
  p_template=> 12521457267846039+ wwv_flow_api.g_id_offset,
  ...
  p_plug_caching=> 'NOT_CACHED',
  p_ajax_enabled=> 'Y',
  p_query_row_template=> 12523164329846043+ wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_report_columns (
  p_id=> 3843831382404556 + wwv_flow_api.g_id_offset,
  p_region_id=> 3843524370404537 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 1,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 3843921447404559 + wwv_flow_api.g_id_offset,
  p_region_id=> 3843524370404537 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 2,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 3844001334404559 + wwv_flow_api.g_id_offset,
  p_region_id=> 3843524370404537 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 3,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 3844103852404559 + wwv_flow_api.g_id_offset,
  p_region_id=> 3843524370404537 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 4,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 3844212000404559 + wwv_flow_api.g_id_offset,
  p_region_id=> 3843524370404537 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 5,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 3844314560404559 + wwv_flow_api.g_id_offset,
  p_region_id=> 3843524370404537 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 6,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 3844423378404559 + wwv_flow_api.g_id_offset,
  p_region_id=> 3843524370404537 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 7,
  p_form_element_id=> null,
  p_column_alias=> 'NOMRBE',
  p_column_display_sequence=> 7,
  p_column_heading=> 'NOMRBE',
  p_column_alignment=>'LEFT',
  p_disable_sort_column=>'Y',
  p_sum_column=> 'N',
  p_hidden_column=> 'N',
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 3844502293404559 + wwv_flow_api.g_id_offset,
  p_region_id=> 3843524370404537 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 8,
  p_form_element_id=> null,
  p_column_alias=> 'TIPO_CLIENTE',
  p_column_display_sequence=> 8,
  p_column_heading=> 'TIPO_CLIENTE',
  p_column_alignment=>'LEFT',
  p_disable_sort_column=>'Y',
  p_sum_column=> 'N',
  p_hidden_column=> 'N',
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 3844618213404559 + wwv_flow_api.g_id_offset,
  p_region_id=> 3843524370404537 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 9,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 3844702955404559 + wwv_flow_api.g_id_offset,
  p_region_id=> 3843524370404537 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 3844800060404560 + wwv_flow_api.g_id_offset,
  p_region_id=> 3843524370404537 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
wwv_flow_api.create_page (
 ...
 ,p_step_template => 12517037316846029 + wwv_flow_api.g_id_offset
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 12528343872846051 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 101,
  p_plug_name=> 'Conectar',
  p_region_name=>'',
  p_escape_on_http_output=>'N',
  p_plug_template=> 12520157847846038+ wwv_flow_api.g_id_offset,
  p_plug_display_sequence=> 10,
  p_plug_new_grid         => false,
  p_plug_new_grid_row     => true,
  p_plug_new_grid_column  => true,
...
wwv_flow_api.create_page_item(
  p_id=>12528467011846053 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 101,
  ...
  p_item_sequence=> 10,
  p_item_plug_id => 12528343872846051+wwv_flow_api.g_id_offset,
  ...
  p_field_template=> 12525747243846046+wwv_flow_api.g_id_offset,
  p_is_persistent=> 'Y',
  p_attribute_01 => 'N',
  p_attribute_02 => 'N',
  p_attribute_03 => 'N',
...
begin
wwv_flow_api.create_page_item(
  p_id=>12528560232846054 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 101,
...
begin
wwv_flow_api.create_page_item(
  p_id=>12528644418846054 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 101,
  p_name=>'P101_LOGIN',
  p_data_type=> '',
  ...
  p_cMaxlength=> null,
  p_cHeight=> null,
  p_tag_attributes  => 'template:'||to_char(12526154709846047 + wwv_flow_api.g_id_offset),
  p_new_grid=> false,
...
wwv_flow_api.create_page_process(
  p_id     => 12528864802846058 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 101,
...
wwv_flow_api.create_page_process(
  p_id     => 12528742235846055 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 101,
...
wwv_flow_api.create_page_process(
  p_id     => 12529059915846058 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 101,
...
wwv_flow_api.create_page_process(
  p_id     => 12528962717846058 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 101,
  p_process_sequence=> 10,
...
wwv_flow_api.create_list (
  p_id=> 12529567938846062 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_name=> 'Navegación',
  p_list_type=> 'STATIC',
  p_list_query=>'',
...
wwv_flow_api.create_list_item (
  p_id=> 7547636284802064 + wwv_flow_api.g_id_offset,
  p_list_id=> 12529567938846062 + wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_menu (
  p_id=> 12529142092846058 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_name=> 'Ruta de navegación ');
 
wwv_flow_api.create_menu_option (
  p_id=>12529967563846084 + wwv_flow_api.g_id_offset,
  p_menu_id=>12529142092846058 + wwv_flow_api.g_id_offset,
  p_parent_id=>0,
...
prompt  ......Page template 12517037316846029
 
begin
 
wwv_flow_api.create_template (
  p_id => 12517037316846029 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_theme_id => 26
 ,p_name => 'Login'
 ,p_is_popup => false
...
prompt  ......Page template 12517137675846031
 
begin
 
wwv_flow_api.create_template (
  p_id => 12517137675846031 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_theme_id => 26
 ,p_name => 'Minimal Page'
 ,p_is_popup => false
...
prompt  ......Page template 12517246466846031
 
begin
 
wwv_flow_api.create_template (
  p_id => 12517246466846031 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_theme_id => 26
...
prompt  ......Page template 12517362118846031
 
begin
 
wwv_flow_api.create_template (
  p_id => 12517362118846031 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_theme_id => 26
...
prompt  ......Page template 12517446367846031
 
begin
 
wwv_flow_api.create_template (
  p_id => 12517446367846031 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_theme_id => 26
...
prompt  ......Page template
+ wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 12523867459846045
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>12523867459846045 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 12523938818846045
...
wwv_flow_api.create_list_template (
  p_id=>12523938818846045 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 12524045519846045
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>12524045519846045 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 12524157663846045
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>12524157663846045 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 12524249426846045
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>12524249426846045 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 12524342344846045
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>12524342344846045 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 12524449515846045
...
wwv_flow_api.create_list_template (
  p_id=>12524449515846045 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 12524542634846045
...
wwv_flow_api.create_list_template (
  p_id=>12524542634846045 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 12524658750846045
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>12524658750846045 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 12524743994846045
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>12524743994846045 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 12524837858846045
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>12524837858846045 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 12524938159846045
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>12524938159846045 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 12525037034846045
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>12525037034846045 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 12525142099846045
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>12525142099846045 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 12525266901846045
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>12525266901846045 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 12525335717846045
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>12525335717846045 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 12525465229846046
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>12525465229846046 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......report template 12522549464846040
...
wwv_flow_api.create_row_template (
  p_id=> 12522549464846040 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 12522651865846043
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 12522651865846043 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 12522739767846043
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 12522739767846043 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 12522839139846043
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 12522839139846043 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 12522939738846043
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 12522939738846043 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 12523047254846043
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 12523047254846043 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 12523164329846043
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 12523164329846043 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 12523246276846043
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 12523246276846043 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 12523348255846043
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 12523348255846043 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 12523458960846043
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 12523458960846043 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 12523541691846043
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 12523541691846043 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......label template 12525560584846046
 
begin
 
begin
wwv_flow_api.create_field_template (
  p_id=> 12525560584846046 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......label template 12525658421846046
 
begin
 
begin
wwv_flow_api.create_field_template (
  p_id=> 12525658421846046 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......label template 12525747243846046
 
begin
 
begin
wwv_flow_api.create_field_template (
  p_id=> 12525747243846046 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......label template 12525847800846046
 
begin
 
begin
wwv_flow_api.create_field_template (
  p_id=> 12525847800846046 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......label template 12525941045846047
 
begin
 
begin
wwv_flow_api.create_field_template (
  p_id=> 12525941045846047 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......label template 12526037278846047
 
begin
 
begin
wwv_flow_api.create_field_template (
  p_id=> 12526037278846047 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......template 12527141111846047
 
begin
 
begin
wwv_flow_api.create_menu_template (
  p_id=> 12527141111846047 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......template 12527257017846047
 
begin
 
begin
wwv_flow_api.create_menu_template (
  p_id=> 12527257017846047 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
--
prompt  ......template 12527667922846049
 
begin
 
begin
wwv_flow_api.create_popup_lov_template (
  p_id=> 12527667922846049 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......template 12527367855846047
 
begin
 
begin
wwv_flow_api.create_calendar_template(
  p_id=> 12527367855846047 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......template 12527459611846049
 
begin
 
begin
wwv_flow_api.create_calendar_template(
  p_id=> 12527459611846049 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......template 12527554136846049
 
begin
 
begin
wwv_flow_api.create_calendar_template(
  p_id=> 12527554136846049 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......theme 12527741534846049
begin
wwv_flow_api.create_theme (
  p_id =>12527741534846049 + wwv_flow_api.g_id_offset,
  p_flow_id =>wwv_flow.g_flow_id,
  p_theme_id  => 26,
  p_theme_name=>'Productivity Applications',
  p_ui_type_name=>'DESKTOP',
  p_is_locked=>false,
  p_default_page_template=>12517944667846032 + wwv_flow_api.g_id_offset,
  p_error_template=>12517446367846031 + wwv_flow_api.g_id_offset,
  p_printer_friendly_template=>12518450767846034 + wwv_flow_api.g_id_offset,
  p_breadcrumb_display_point=>'REGION_POSITION_01',
  p_sidebar_display_point=>'REGION_POSITION_02',
  p_login_template=>12517037316846029 + wwv_flow_api.g_id_offset,
  p_default_button_template=>12526154709846047 + wwv_flow_api.g_id_offset,
  p_default_region_template=>12521457267846039 + wwv_flow_api.g_id_offset,
  p_default_chart_template =>12519852021846038 + wwv_flow_api.g_id_offset,
  p_default_form_template  =>12520157847846038 + wwv_flow_api.g_id_offset,
  p_default_reportr_template   =>12521457267846039 + wwv_flow_api.g_id_offset,
  p_default_tabform_template=>12521457267846039 + wwv_flow_api.g_id_offset,
  p_default_wizard_template=>12522257477846039 + wwv_flow_api.g_id_offset,
  p_default_menur_template=>12519442038846035 + wwv_flow_api.g_id_offset,
  p_default_listr_template=>12519767426846038 + wwv_flow_api.g_id_offset,
  p_default_irr_template=>12520538566846038 + wwv_flow_api.g_id_offset,
  p_default_report_template   =>12523164329846043 + wwv_flow_api.g_id_offset,
  p_default_label_template=>12525747243846046 + wwv_flow_api.g_id_offset,
  p_default_menu_template=>12527141111846047 + wwv_flow_api.g_id_offset,
  p_default_calendar_template=>12527367855846047 + wwv_flow_api.g_id_offset,
  p_default_list_template=>12525266901846045 + wwv_flow_api.g_id_offset,
  p_default_option_label=>12525847800846046 + wwv_flow_api.g_id_offset,
  ...
  p_default_required_label=>12526037278846047 + wwv_flow_api.g_id_offset);
end;
/
...
prompt  ......authentication 12528062492846051
 
begin
 
wwv_flow_api.create_authentication (
  p_id => 12528062492846051 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
...
wwv_flow_api.create_install (
  p_id => 3840123850304722 + wwv_flow_api.g_id_offset,
  p_flow_id => wwv_flow.g_flow_id,
