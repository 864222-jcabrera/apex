...
prompt  APPLICATION 102 - DAF/UCI
--
-- Application Export:
--   Application:     102
--   Name:            DAF/UCI
...
wwv_flow_api.create_flow(
  ...
  p_name  => nvl(wwv_flow_application_install.get_application_name,'DAF/UCI'),
  p_alias => nvl(wwv_flow_application_install.get_application_alias,'F_102'),
  p_page_view_logging => 'YES',
  p_page_protection_enabled_y_n=> 'Y',
  p_checksum_salt=> '65F0FD145559FB44188D712A7313C317F2CC31C248EF5BB8022DEE531E94975F',
  ...
  p_authentication_id=> 4037521262647838 + wwv_flow_api.g_id_offset,
  p_logout_url=> '',
  p_application_tab_set=> 0,
  p_logo_image => 'TEXT:DAF/UCI',
  p_public_url_prefix => '',
  p_public_user=> '',
  p_dbauth_url_prefix => '',
  ...
  p_restrict_to_user_list=> 'afernandez, anegri, dbarrios, jcabrera, vvallejos',
  ...
  p_last_upd_yyyymmddhh24miss=> '20150511140354',
  p_ui_type_name => null,
...
wwv_flow_api.create_user_interface (
  p_id => 4037318230647816 + wwv_flow_api.g_id_offset
...
wwv_flow_api.create_plugin_setting (
  p_id => 4026413251647744 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
...
wwv_flow_api.create_icon_bar_item(
  p_id => 4037409206647833 + wwv_flow_api.g_id_offset,
  p_flow_id => wwv_flow.g_flow_id,
  p_icon_sequence=> 200,
  p_icon_image => '',
...
wwv_flow_api.create_tab (
  p_id=> 4038908473647865 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_tab_set=> 'TS1',
  p_tab_sequence=> 10,
  p_tab_name=> 'T_HOME',
...
wwv_flow_api.create_page (
  p_flow_id => wwv_flow.g_flow_id
 ,p_id => 1
 ,p_user_interface_id => 4037318230647816 + wwv_flow_api.g_id_offset
 ,p_tab_set => 'TS1'
 ,p_name => 'Home'
 ,p_step_title => 'Home'
...
'No help is available for this page.'
 ,p_last_updated_by => 'ANEGRI'
 ,p_last_upd_yyyymmddhh24miss => '20150511125934'
  );
null;
...
wwv_flow_api.create_page_plug (
  p_id=> 4039113892647869 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1,
  p_plug_name=> 'Breadcrumbs',
  p_region_name=>'',
  p_escape_on_http_output=>'N',
  p_plug_template=> 4028901329647772+ wwv_flow_api.g_id_offset,
  ...
  p_plug_source=> s,
  p_plug_source_type=> 'M'|| to_char(4038605398647858 + wwv_flow_api.g_id_offset),
  p_menu_template_id=> 4036627210647797+ wwv_flow_api.g_id_offset,
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 4042921271999411 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1,
  ...
  p_plug_item_display_point=> 'ABOVE',
  p_plug_source=> s,
  p_plug_source_type=> 4042419133999410 + wwv_flow_api.g_id_offset,
  p_list_template_id=> 4033126169647784+ wwv_flow_api.g_id_offset,
  p_translate_title=> 'Y',
  p_plug_query_row_template=> 1,
  p_plug_query_headings_type=> 'COLON_DELMITED_LIST',
  p_plug_query_row_count_max => 500,
...
prompt  ...PAGE 2: Facturas con TES 509
--
...
wwv_flow_api.create_page (
 ...
 ,p_user_interface_id => 4037318230647816 + wwv_flow_api.g_id_offset
 ,p_tab_set => 'TS1'
 ,p_name => 'Facturas con TES 509'
 ,p_step_title => 'Facturas con TES 509'
 ,p_step_sub_title => 'Facturas con TES 509'
 ,p_step_sub_title_type => 'TEXT_WITH_SUBSTITUTIONS'
 ,p_include_apex_css_js_yn => 'Y'
 ,p_autocomplete_on_off => 'ON'
 ,p_page_is_public_y_n => 'N'
...
'No help is available for this page.'
 ,p_last_updated_by => 'ANEGRI'
 ,p_last_upd_yyyymmddhh24miss => '20150511120114'
  );
null;
...
'  VALIDACION.F_LOCAL1@BDTOTUS1(T.C6_FILIAL) AS FILIAL, '||unistr('\000a')||
'  TO_DATE(T.C6_DATFAT, ''YYYYMMDD'') AS FECHA_FACTURACION,'||unistr('\000a')||
'  T1.C5_CLIENT AS CLIENTE, '||unistr('\000a')||
'  T1.C5_NOME AS NOMBRE, '||unistr('\000a')||
'  T.C6_PRODUTO AS PRODUCTO, '||unistr('\000a')||
'  T.C6_DESCRI AS DESCRIPCION, '||unistr('\000a')||
'  T.C6_NUM AS NUM_PEDIDO, '||unistr('\000a')||
'  T1.C5_NOTA AS FACTURA, '||unistr('\000a')||
'  T.C6_TES  AS TES, '||unistr('\000a')||
'  T1.C5_DOCGER AS TIPO_DOCUMENTO'||unistr('\000a')||
' '||unistr('\000a')||
'FROM VALIDACION.SC6010@BDTOTUS1 T '||unistr('\000a')||
'INNER JOIN '||unistr('\000a')||
'  VALIDAC';

s:=s||'ION.SC5010@BDTOTUS1 T1 '||unistr('\000a')||
'ON '||unistr('\000a')||
'  T.C6_FILIAL = T1.C5_FILIAL '||unistr('\000a')||
'  AND T.C6_NUM = T1.C5_NUM '||unistr('\000a')||
'WHERE '||unistr('\000a')||
'  T1.C5_DOCGER = ''1'' '||unistr('\000a')||
'  AND T.C6_TES = ''509'' '||unistr('\000a')||
'  AND T.C6_NOTA <> '' '''||unistr('\000a')||
'  AND T.D_E_L_E_T_ = '' '' '||unistr('\000a')||
'ORDER BY 1;';

wwv_flow_api.create_page_plug (
  p_id=> 4039702594654160 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 2,
  p_plug_name=> 'Facturas con TES 509',
  p_region_name=>'',
  p_escape_on_http_output=>'N',
  p_plug_template=> 4030011494647776+ wwv_flow_api.g_id_offset,
  p_plug_display_sequence=> 10,
  p_plug_new_grid         => false,
  p_plug_new_grid_row     => true,
  p_plug_new_grid_column  => true,
...
a1:=a1||'ION.SC5010@BDTOTUS1 T1 '||unistr('\000a')||
'ON '||unistr('\000a')||
'  T.C6_FILIAL = T1.C5_FILIAL '||unistr('\000a')||
'  AND T.C6_NUM = T1.C5_NUM '||unistr('\000a')||
'WHERE '||unistr('\000a')||
...
wwv_flow_api.create_worksheet(
  p_id=> 4039822144654160+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 2,
  p_region_id=> 4039702594654160+wwv_flow_api.g_id_offset,
  p_name=> 'Facturas con TES 509',
  p_folder_id=> null, 
  p_alias=> '',
  p_report_id_item=> '',
  ...
  p_owner=>'ANEGRI',
  p_internal_uid=> 4039822144654160);
end;
/
begin
wwv_flow_api.create_worksheet_column(
  p_id => 4040012636654171+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 2,
  p_worksheet_id => 4039822144654160+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 4040116091654173+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 2,
  p_worksheet_id => 4039822144654160+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'FECHA_FACTURACION',
  p_display_order          =>2,
  p_column_identifier      =>'B',
  p_column_label           =>'Fecha Facturacion',
  p_report_label           =>'Fecha Facturacion',
  p_sync_form_label        =>'Y',
  p_display_in_default_rpt =>'Y',
  p_is_sortable            =>'Y',
  p_allow_sorting          =>'Y',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 4040218484654173+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 2,
  p_worksheet_id => 4039822144654160+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 4040324329654174+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 2,
  p_worksheet_id => 4039822144654160+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 4040426476654174+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 2,
  p_worksheet_id => 4039822144654160+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 4040511043654174+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 2,
  p_worksheet_id => 4039822144654160+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 4040612080654174+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 2,
  p_worksheet_id => 4039822144654160+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'NUM_PEDIDO',
  p_display_order          =>7,
  p_column_identifier      =>'G',
  p_column_label           =>'Num Pedido',
  p_report_label           =>'Num Pedido',
  p_sync_form_label        =>'Y',
  p_display_in_default_rpt =>'Y',
  p_is_sortable            =>'Y',
  p_allow_sorting          =>'Y',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 4040729328654175+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 2,
  p_worksheet_id => 4039822144654160+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 4040825993654175+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 2,
  p_worksheet_id => 4039822144654160+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'TES',
  p_display_order          =>9,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 4040920710654175+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 2,
  p_worksheet_id => 4039822144654160+wwv_flow_api.g_id_offset,
...
begin
rc1:=rc1||'FILIAL:FECHA_FACTURACION:CLIENTE:NOMBRE:PRODUCTO:DESCRIPCION:NUM_PEDIDO:FACTURA:TES:TIPO_DOCUMENTO';

wwv_flow_api.create_worksheet_rpt(
  p_id => 4041005066654746+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 2,
  p_worksheet_id => 4039822144654160+wwv_flow_api.g_id_offset,
  p_session_id  => null,
...
wwv_flow_api.create_page (
 ...
 ,p_step_template => 4026513074647750 + wwv_flow_api.g_id_offset
 ,p_page_is_public_y_n => 'Y'
 ,p_cache_page_yn => 'N'
 ,p_last_upd_yyyymmddhh24miss => '20150511120011'
  );
null;
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 4037828916647851 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 101,
  p_plug_name=> 'Login',
  p_region_name=>'',
  p_escape_on_http_output=>'N',
  p_plug_template=> 4029601044647774+ wwv_flow_api.g_id_offset,
  p_plug_display_sequence=> 10,
  p_plug_new_grid         => false,
  p_plug_new_grid_row     => true,
  p_plug_new_grid_column  => true,
...
wwv_flow_api.create_page_item(
  p_id=>4037920161647853 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 101,
  ...
  p_item_sequence=> 10,
  p_item_plug_id => 4037828916647851+wwv_flow_api.g_id_offset,
  ...
  p_field_template=> 4035228622647792+wwv_flow_api.g_id_offset,
  p_is_persistent=> 'Y',
  p_attribute_01 => 'N',
  p_attribute_02 => 'N',
  p_attribute_03 => 'N',
...
begin
wwv_flow_api.create_page_item(
  p_id=>4038006106647853 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 101,
...
begin
wwv_flow_api.create_page_item(
  p_id=>4038123558647854 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 101,
  p_name=>'P101_LOGIN',
  p_data_type=> '',
  ...
  p_cMaxlength=> null,
  p_cHeight=> null,
  p_tag_attributes  => 'template:'||to_char(4035630692647794 + wwv_flow_api.g_id_offset),
  p_new_grid=> false,
...
wwv_flow_api.create_page_process(
  p_id     => 4038331736647857 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 101,
...
wwv_flow_api.create_page_process(
  p_id     => 4038201712647855 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 101,
...
wwv_flow_api.create_page_process(
  p_id     => 4038505407647858 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 101,
...
wwv_flow_api.create_page_process(
  p_id     => 4038427516647857 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 101,
  p_process_sequence=> 10,
...
wwv_flow_api.create_list (
  p_id=> 4041932508993831 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_name=> 'Navigation',
  p_list_type=> 'STATIC',
  p_list_query=>'',
...
wwv_flow_api.create_list_item (
  p_id=> 4042119457993834 + wwv_flow_api.g_id_offset,
  p_list_id=> 4041932508993831 + wwv_flow_api.g_id_offset,
  p_list_item_type=> 'LINK',
  p_list_item_status=> 'PUBLIC',
  p_item_displayed=> 'BY_DEFAULT',
  p_list_item_display_sequence=>10,
  p_list_item_link_text=> 'Facturas con TES 509',
...
wwv_flow_api.create_list (
  p_id=> 4042419133999410 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_name=> 'Navigation',
  p_list_type=> 'STATIC',
  p_list_query=>'',
...
wwv_flow_api.create_list_item (
  p_id=> 4042604570999411 + wwv_flow_api.g_id_offset,
  p_list_id=> 4042419133999410 + wwv_flow_api.g_id_offset,
  p_list_item_type=> 'LINK',
  p_list_item_status=> 'PUBLIC',
  p_item_displayed=> 'BY_DEFAULT',
  p_list_item_display_sequence=>10,
...
wwv_flow_api.create_menu (
  p_id=> 4038605398647858 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_name=> ' Breadcrumb');
 
wwv_flow_api.create_menu_option (
  p_id=>4039028087647867 + wwv_flow_api.g_id_offset,
  p_menu_id=>4038605398647858 + wwv_flow_api.g_id_offset,
  p_parent_id=>0,
...
prompt  ......Page template 4026513074647750
 
begin
 
wwv_flow_api.create_template (
  p_id => 4026513074647750 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_theme_id => 26
 ,p_name => 'Login'
 ,p_is_popup => false
...
prompt  ......Page template 4026601293647756
 
begin
 
wwv_flow_api.create_template (
  p_id => 4026601293647756 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_theme_id => 26
 ,p_name => 'Minimal Page'
 ,p_is_popup => false
...
prompt  ......Page template 4026727087647757
 
begin
 
wwv_flow_api.create_template (
  p_id => 4026727087647757 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_theme_id => 26
...
prompt  ......Page template 4026830176647757
 
begin
 
wwv_flow_api.create_template (
  p_id => 4026830176647757 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_theme_id => 26
...
prompt  ......Page template 4026910730647757
 
begin
 
wwv_flow_api.create_template (
  p_id => 4026910730647757 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_theme_id => 26
...
prompt  ......Page template 4027008921647758
 
begin
 
wwv_flow_api.create_template (
  p_id => 4027008921647758 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_theme_id => 26
...
prompt  ......Page template 4027125252647758
 
begin
 
wwv_flow_api.create_template (
  p_id => 4027125252647758 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_theme_id => 26
...
prompt  ......Page template 4027200479647758
 
begin
 
wwv_flow_api.create_template (
  p_id => 4027200479647758 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_theme_id => 26
...
prompt  ......Page template 4027316018647759
 
begin
 
wwv_flow_api.create_template (
  p_id => 4027316018647759 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_theme_id => 26
...
prompt  ......Page template 4027427147647759
 
begin
 
wwv_flow_api.create_template (
  p_id => 4027427147647759 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_theme_id => 26
...
prompt  ......Page template 4027506008647760
 
begin
 
wwv_flow_api.create_template (
  p_id => 4027506008647760 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_theme_id => 26
...
prompt  ......Page template 4027611873647760
 
begin
 
wwv_flow_api.create_template (
  p_id => 4027611873647760 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_theme_id => 26
...
prompt  ......Page template 4027703019647760
 
begin
 
wwv_flow_api.create_template (
  p_id => 4027703019647760 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_theme_id => 26
...
prompt  ......Page template 4027801028647760
 
begin
 
wwv_flow_api.create_template (
  p_id => 4027801028647760 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_theme_id => 26
 ,p_name => 'Popup'
 ,p_is_popup => false
...
prompt  ......Page template 4027900993647761
 
begin
 
wwv_flow_api.create_template (
  p_id => 4027900993647761 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_theme_id => 26
...
prompt  ......Page template 4028012001647761
 
begin
 
wwv_flow_api.create_template (
  p_id => 4028012001647761 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_theme_id => 26
...
prompt  ......Page template 4028111314647762
 
begin
 
wwv_flow_api.create_template (
  p_id => 4028111314647762 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_theme_id => 26
...
prompt  ......Page template 4028224591647762
 
begin
 
wwv_flow_api.create_template (
  p_id => 4028224591647762 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_theme_id => 26
...
prompt  ......Page template 4028310042647762
 
begin
 
wwv_flow_api.create_template (
  p_id => 4028310042647762 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_theme_id => 26
...
prompt  ......Button Template 4035630692647794
 
begin
 
wwv_flow_api.create_button_templates (
  p_id => 4035630692647794 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
...
prompt  ......Button Template 4035725719647796
 
begin
 
wwv_flow_api.create_button_templates (
  p_id => 4035725719647796 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
...
prompt  ......Button Template 4035805493647797
 
begin
 
wwv_flow_api.create_button_templates (
  p_id => 4035805493647797 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
...
prompt  ......Button Template 4035903635647797
 
begin
 
wwv_flow_api.create_button_templates (
  p_id => 4035903635647797 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
...
prompt  ......Button Template 4036003218647797
 
begin
 
wwv_flow_api.create_button_templates (
  p_id => 4036003218647797 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
...
prompt  ......Button Template 4036129560647797
 
begin
 
wwv_flow_api.create_button_templates (
  p_id => 4036129560647797 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
...
prompt  ......Button Template 4036215909647797
 
begin
 
wwv_flow_api.create_button_templates (
  p_id => 4036215909647797 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
...
prompt  ......Button Template 4036325347647797
 
begin
 
wwv_flow_api.create_button_templates (
  p_id => 4036325347647797 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
...
prompt  ......Button Template 4036403096647797
 
begin
 
wwv_flow_api.create_button_templates (
  p_id => 4036403096647797 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
...
prompt  ......Button Template 4036530034647797
 
begin
 
wwv_flow_api.create_button_templates (
  p_id => 4036530034647797 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
...
prompt  ......region template 4028424408647765
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 4028424408647765 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
...
prompt  ......region template 4028519677647772
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 4028519677647772 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
...
prompt  ......region template 4028605538647772
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 4028605538647772 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
...
prompt  ......region template 4028701625647772
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 4028701625647772 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
...
prompt  ......region template 4028826671647772
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 4028826671647772 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
...
prompt  ......region template 4028901329647772
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 4028901329647772 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
...
prompt  ......region template 4029007411647773
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 4029007411647773 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
...
prompt  ......region template 4029102189647773
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 4029102189647773 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
'<section class="uButtonRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||unistr('\000a')||
...
prompt  ......region template 4029218027647773
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 4029218027647773 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
...
prompt  ......region template 4029328678647773
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 4029328678647773 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||unistr('\000a')||
...
prompt  ......region template 4029402494647773
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 4029402494647773 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
...
prompt  ......region template 4029519420647774
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 4029519420647774 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
...
prompt  ......region template 4029601044647774
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 4029601044647774 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||unistr('\000a')||
...
prompt  ......region template 4029716895647775
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 4029716895647775 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
...
prompt  ......region template 4029813398647775
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 4029813398647775 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
...
prompt  ......region template 4029919579647775
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 4029919579647775 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
'<section class="uRegion uBorderlessRegion uHideShowRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||unistr('\000a')||
...
prompt  ......region template 4030011494647776
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 4030011494647776 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
...
prompt  ......region template 4030122819647776
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 4030122819647776 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
...
prompt  ......region template 4030231978647776
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 4030231978647776 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
...
prompt  ......region template 4030331630647776
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 4030331630647776 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||unistr('\000a')||
...
prompt  ......region template 4030419259647776
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 4030419259647776 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
...
prompt  ......region template 4030500448647776
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 4030500448647776 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
...
prompt  ......region template 4030605402647776
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 4030605402647776 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
...
prompt  ......region template 4030708481647776
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 4030708481647776 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
...
prompt  ......region template 4030831032647776
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 4030831032647776 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||unistr('\000a')||
...
prompt  ......region template 4030927778647776
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 4030927778647776 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||unistr('\000a')||
...
prompt  ......region template 4031031674647776
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 4031031674647776 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
...
prompt  ......region template 4031109574647777
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 4031109574647777 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
'<section class="uRegion uWhiteRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||unistr('\000a')||
...
prompt  ......region template 4031221047647777
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 4031221047647777 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||unistr('\000a')||
...
prompt  ......region template 4031304558647777
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 4031304558647777 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
...
prompt  ......region template 4031405861647777
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 4031405861647777 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||unistr('\000a')||
...
prompt  ......region template 4031507472647777
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 4031507472647777 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
'<section class="uRegion uWhiteRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||unistr('\000a')||
...
prompt  ......region template 4031620597647777
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 4031620597647777 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
...
prompt  ......region template 4031732357647777
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 4031732357647777 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||unistr('\000a')||
...
prompt  ......region template 4031806214647778
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 4031806214647778 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||unistr('\000a')||
...
prompt  ......region template 4031913744647778
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 4031913744647778 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
...
prompt  ......list template 4033126169647784
...
wwv_flow_api.create_list_template (
  p_id=>4033126169647784 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
...
prompt  ......list template 4033209776647786
...
wwv_flow_api.create_list_template (
  p_id=>4033209776647786 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 4033327529647787
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>4033327529647787 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 4033432648647787
...
wwv_flow_api.create_list_template (
  p_id=>4033432648647787 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 4033528017647787
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>4033528017647787 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 4033615792647787
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>4033615792647787 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 4033715306647787
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>4033715306647787 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 4033819953647787
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>4033819953647787 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 4033929434647787
...
wwv_flow_api.create_list_template (
  p_id=>4033929434647787 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 4034013706647788
...
wwv_flow_api.create_list_template (
  p_id=>4034013706647788 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 4034127283647788
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>4034127283647788 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 4034211139647788
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>4034211139647788 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 4034310914647788
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>4034310914647788 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 4034415355647788
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>4034415355647788 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 4034513588647788
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>4034513588647788 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 4034618474647788
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>4034618474647788 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 4034728085647788
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>4034728085647788 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 4034809347647788
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>4034809347647788 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 4034916053647788
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>4034916053647788 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......report template 4032025341647779
...
wwv_flow_api.create_row_template (
  p_id=> 4032025341647779 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 4032117718647782
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 4032117718647782 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 4032206051647782
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 4032206051647782 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 4032323408647782
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 4032323408647782 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 4032418388647782
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 4032418388647782 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 4032504739647782
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 4032504739647782 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 4032604011647782
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 4032604011647782 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 4032714478647783
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 4032714478647783 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 4032830310647783
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 4032830310647783 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 4032907225647783
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 4032907225647783 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 4033010496647783
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 4033010496647783 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......label template 4035021187647789
 
begin
 
begin
wwv_flow_api.create_field_template (
  p_id=> 4035021187647789 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......label template 4035104286647792
 
begin
 
begin
wwv_flow_api.create_field_template (
  p_id=> 4035104286647792 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......label template 4035228622647792
 
begin
 
begin
wwv_flow_api.create_field_template (
  p_id=> 4035228622647792 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......label template 4035307411647792
 
begin
 
begin
wwv_flow_api.create_field_template (
  p_id=> 4035307411647792 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......label template 4035430118647792
 
begin
 
begin
wwv_flow_api.create_field_template (
  p_id=> 4035430118647792 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......label template 4035521631647792
 
begin
 
begin
wwv_flow_api.create_field_template (
  p_id=> 4035521631647792 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......template 4036627210647797
 
begin
 
begin
wwv_flow_api.create_menu_template (
  p_id=> 4036627210647797 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......template 4036712998647800
 
begin
 
begin
wwv_flow_api.create_menu_template (
  p_id=> 4036712998647800 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
--
prompt  ......template 4037103581647804
 
begin
 
begin
wwv_flow_api.create_popup_lov_template (
  p_id=> 4037103581647804 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......template 4036817428647800
 
begin
 
begin
wwv_flow_api.create_calendar_template(
  p_id=> 4036817428647800 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......template 4036923399647803
 
begin
 
begin
wwv_flow_api.create_calendar_template(
  p_id=> 4036923399647803 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......template 4037004263647803
 
begin
 
begin
wwv_flow_api.create_calendar_template(
  p_id=> 4037004263647803 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......theme 4037209903647813
begin
wwv_flow_api.create_theme (
  p_id =>4037209903647813 + wwv_flow_api.g_id_offset,
  p_flow_id =>wwv_flow.g_flow_id,
  p_theme_id  => 26,
  p_theme_name=>'Productivity Applications',
  p_ui_type_name=>'DESKTOP',
  p_is_locked=>false,
  p_default_page_template=>4027427147647759 + wwv_flow_api.g_id_offset,
  p_error_template=>4026910730647757 + wwv_flow_api.g_id_offset,
  p_printer_friendly_template=>4027900993647761 + wwv_flow_api.g_id_offset,
  p_breadcrumb_display_point=>'REGION_POSITION_01',
  p_sidebar_display_point=>'REGION_POSITION_02',
  p_login_template=>4026513074647750 + wwv_flow_api.g_id_offset,
  p_default_button_template=>4035630692647794 + wwv_flow_api.g_id_offset,
  p_default_region_template=>4030927778647776 + wwv_flow_api.g_id_offset,
  p_default_chart_template =>4029328678647773 + wwv_flow_api.g_id_offset,
  p_default_form_template  =>4029601044647774 + wwv_flow_api.g_id_offset,
  p_default_reportr_template   =>4030927778647776 + wwv_flow_api.g_id_offset,
  p_default_tabform_template=>4030927778647776 + wwv_flow_api.g_id_offset,
  p_default_wizard_template=>4031732357647777 + wwv_flow_api.g_id_offset,
  p_default_menur_template=>4028901329647772 + wwv_flow_api.g_id_offset,
  p_default_listr_template=>4029218027647773 + wwv_flow_api.g_id_offset,
  p_default_irr_template=>4030011494647776 + wwv_flow_api.g_id_offset,
  p_default_report_template   =>4032604011647782 + wwv_flow_api.g_id_offset,
  p_default_label_template=>4035228622647792 + wwv_flow_api.g_id_offset,
  p_default_menu_template=>4036627210647797 + wwv_flow_api.g_id_offset,
  p_default_calendar_template=>4036817428647800 + wwv_flow_api.g_id_offset,
  p_default_list_template=>4034728085647788 + wwv_flow_api.g_id_offset,
  p_default_option_label=>4035307411647792 + wwv_flow_api.g_id_offset,
  ...
  p_default_required_label=>4035521631647792 + wwv_flow_api.g_id_offset);
end;
/
...
prompt  ......authentication 4037521262647838
 
begin
 
wwv_flow_api.create_authentication (
  p_id => 4037521262647838 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
