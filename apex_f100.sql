...
prompt  APPLICATION 100 - DAF/SALARIOS
--
-- Application Export:
--   Application:     100
--   Name:            DAF/SALARIOS
...
wwv_flow_api.create_flow(
  ...
  p_name  => nvl(wwv_flow_application_install.get_application_name,'DAF/SALARIOS'),
  p_alias => nvl(wwv_flow_application_install.get_application_alias,'F_121'),
  ...
  p_authentication_id=> 9026002780128681 + wwv_flow_api.g_id_offset,
  p_logout_url=> '',
  p_application_tab_set=> 0,
  p_logo_image => 'TEXT:DAF/SALARIOS',
  p_public_url_prefix => '',
  ...
  p_restrict_to_user_list=> 'JCABRERA,CMELLO,ANEGRI,LAGUIRRE,JKROLL,LSALINAS,FPENA,VLOPEZ',
  ...
  p_last_upd_yyyymmddhh24miss=> '20150520125702',
  p_ui_type_name => null,
...
wwv_flow_api.create_user_interface (
  p_id => 9025803807128680 + wwv_flow_api.g_id_offset
...
wwv_flow_api.create_plugin_setting (
  p_id => 9014908490128568 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
...
wwv_flow_api.create_icon_bar_item(
  p_id => 9025901799128681 + wwv_flow_api.g_id_offset,
  p_flow_id => wwv_flow.g_flow_id,
  p_icon_sequence=> 200,
  p_icon_image => '',
...
wwv_flow_api.create_tab (
  p_id=> 9027412961128695 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_tab_set=> 'TS1',
  p_tab_sequence=> 10,
  p_tab_name=> 'T_HOME',
...
wwv_flow_api.create_page (
  p_flow_id => wwv_flow.g_flow_id
 ,p_id => 1
 ,p_user_interface_id => 9025803807128680 + wwv_flow_api.g_id_offset
 ,p_tab_set => 'TS1'
 ,p_name => 'Home'
 ,p_step_title => 'Home'
...
wwv_flow_api.create_page_plug (
  p_id=> 9027701068128700 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1,
  p_plug_name=> 'Navigation',
  p_region_name=>'',
  p_escape_on_http_output=>'N',
  p_plug_template=> 9019404269128586+ wwv_flow_api.g_id_offset,
  ...
  p_plug_source=> s,
  p_plug_source_type=> 9027506847128696 + wwv_flow_api.g_id_offset,
  p_list_template_id=> 9023205966128600+ wwv_flow_api.g_id_offset,
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 9027912497128703 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1,
  p_plug_name=> 'Breadcrumbs',
  p_region_name=>'',
  p_escape_on_http_output=>'N',
  p_plug_template=> 9017401333128583+ wwv_flow_api.g_id_offset,
  p_plug_display_sequence=> 10,
  p_plug_new_grid         => false,
  p_plug_new_grid_row     => true,
  p_plug_new_grid_column  => true,
  ...
  p_plug_item_display_point=> 'ABOVE',
  p_plug_source=> s,
  p_plug_source_type=> 'M'|| to_char(9027106612128692 + wwv_flow_api.g_id_offset),
  p_menu_template_id=> 9025106977128609+ wwv_flow_api.g_id_offset,
  p_plug_query_row_template=> 1,
  p_plug_query_headings_type=> 'COLON_DELMITED_LIST',
  p_plug_query_row_count_max => 500,
  p_plug_display_condition_type => '',
...
'No help is available for this page.'
 ,p_last_updated_by => 'YPSA'
 ,p_last_upd_yyyymmddhh24miss => '20141203163459'
  );
null;
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 9028332216128709 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 2,
  p_plug_name=> 'Breadcrumbs',
  p_region_name=>'',
  ...
  p_plug_source=> s,
  p_plug_source_type=> 'M'|| to_char(9027106612128692 + wwv_flow_api.g_id_offset),
  p_menu_template_id=> 9025215404128610+ wwv_flow_api.g_id_offset,
  p_translate_title=> 'Y',
  p_plug_query_row_template=> 1,
  p_plug_query_headings_type=> 'COLON_DELMITED_LIST',
  p_plug_query_row_count_max => 500,
...
'  t.d2_filial as SUCURSAL,'||unistr('\000a')||
'  t.d2_serie as "NRO.SERIE",'||unistr('\000a')||
'  trim(t1.f2_doc) as "NRO.DOCUMENTO",'||unistr('\000a')||
'  trim(t.d2_numseri) as "TRAZABILIDAD",'||unistr('\000a')||
'  trim(t.d2_cod) as PRODUCTO,'||unistr('\000a')||
'  UPPER(t.d2_descri) as DESCRIPCION,'||unistr('\000a')||
'  t.d2_quant as CANTIDAD,'||unistr('\000a')||
'  TRIM(TO_CHAR(t.d2_total * t1.f2_txmoeda,''999999999990D99'',''nls_numeric_characters = '''',.'''''')) as "VALOR TOTAL",'||unistr('\000a')||
'  t1.f2_cliente as CLIENTE,'||unistr('\000a')||
'  t1.f2_loja as TIENDA,'||unistr('\000a')||
'';

s:=s||'  SUBSTR(t1.f2_emissao,7,2) || ''/'' || SUBSTR(t1.f2_emissao,5,2)  || ''/'' ||  SUBSTR(t1.f2_emissao,1,4) as EMISION,'||unistr('\000a')||
'  t1.f2_vend1 as "COD.VENDEDOR",'||unistr('\000a')||
'  UPPER(t5.a3_nome) as "NOMBRE VENDEDOR",'||unistr('\000a')||
'  TRIM(TO_CHAR(t1.f2_txmoeda * t.d2_valimp1,''999999999990D99'',''nls_numeric_characters = '''',.'''''')) as "IVA $",'||unistr('\000a')||
'  t.d2_alqimp1 as "IVA %",'||unistr('\000a')||
'  t1.f2_moeda as MONEDA,'||unistr('\000a')||
'  TRIM(TO_CHAR(t1.f2_txmoeda,''999999999990D99'',''n';

s:=s||'ls_numeric_characters = '''',.'''''')) as "TASA CAMBIO",'||unistr('\000a')||
'  TRIM(TO_CHAR(t1.f2_txmoeda * (t.d2_total - t.d2_valimp1),''999999999990D99'',''nls_numeric_characters = '''',.'''''')) as "VALOR NETO",'||unistr('\000a')||
'  TRIM(TO_CHAR(t.d2_custo1,''999999999990D99'',''nls_numeric_characters = '''',.'''''')) as COSTO,'||unistr('\000a')||
'  t2.c5_num as PEDIDO,'||unistr('\000a')||
'  t2.c5_pedori as "PEDIDO ORIGINAL",'||unistr('\000a')||
'  t.d2_tes as "TIPO SALIDA",'||unistr('\000a')||
'  t3.b1_marca as MARCA,'||unistr('\000a')||
'  t3.b1_grupo ';

s:=s||'as LINEA,'||unistr('\000a')||
'  t3.b1_family as FAMILIA,'||unistr('\000a')||
'  TRIM(TO_CHAR(t4.b2_cm1,''999999999990D99999999'',''nls_numeric_characters = '''',.'''''')) as "COSTO UNITARIO",'||unistr('\000a')||
'  SUBSTR(t4.b2_usai,7,2) || ''/'' || SUBSTR(t4.b2_usai,5,2) || ''/'' || SUBSTR(t4.b2_usai,1,4)  as "ULTIMA SALIDA"'||unistr('\000a')||
'  '||unistr('\000a')||
'from'||unistr('\000a')||
'  validacion.sd2010@BDTOTUS1 t, '||unistr('\000a')||
'  validacion.sf2010@BDTOTUS1 t1,'||unistr('\000a')||
'  validacion.sc5010@BDTOTUS1 t2, '||unistr('\000a')||
'  validacion.sb1010@BDTOTUS1 t3, '||unistr('\000a')||
'  va';

s:=s||'lidacion.sb2010@BDTOTUS1 t4, '||unistr('\000a')||
'  validacion.sa3010@BDTOTUS1 t5'||unistr('\000a')||
'  '||unistr('\000a')||
'where'||unistr('\000a')||
'  t1.f2_filial = t.d2_filial'||unistr('\000a')||
'  and t1.f2_doc = t.d2_doc'||unistr('\000a')||
'  and t1.f2_serie = t.d2_serie'||unistr('\000a')||
'  and t1.f2_cliente = t.d2_cliente'||unistr('\000a')||
'  and t1.f2_loja = t.d2_loja'||unistr('\000a')||
'  and t1.d_e_l_e_t_ <> ''*'''||unistr('\000a')||
'  and t1.r_e_c_d_e_l_ = 0'||unistr('\000a')||
''||unistr('\000a')||
'  and t2.c5_filial (+) = t.d2_filial'||unistr('\000a')||
'  and t2.c5_num (+) = t.d2_pedido'||unistr('\000a')||
'  and t2.d_e_l_e_t_ (+) <> ''*'''||unistr('\000a')||
''||unistr('\000a')||
'  and t3.b1_cod = t.d';

s:=s||'2_cod'||unistr('\000a')||
'  and t3.d_e_l_e_t_ <> ''*'''||unistr('\000a')||
''||unistr('\000a')||
''||unistr('\000a')||
'  and t4.b2_filial = t.d2_filial'||unistr('\000a')||
'  and t4.b2_local = t.d2_local'||unistr('\000a')||
'  and t4.b2_cod = t.d2_cod'||unistr('\000a')||
'  and t4.d_e_l_e_t_ <> ''*'''||unistr('\000a')||
''||unistr('\000a')||
'  and t5.a3_cod (+) = t1.f2_vend1'||unistr('\000a')||
'  and t5.d_e_l_e_t_ (+) <> ''*'''||unistr('\000a')||
'  '||unistr('\000a')||
'  and t.d2_emissao >= :P2_DESDEFECHA'||unistr('\000a')||
'  and t.d2_emissao <= :P2_HASTAFECHA'||unistr('\000a')||
'  and t.d2_especie = ''NF'''||unistr('\000a')||
'  and t.d_e_l_e_t_ <> ''*''  '||unistr('\000a')||
'  and t.r_e_c_d_e_l_ = 0'||unistr('\000a')||
'';

wwv_flow_api.create_page_plug (
  p_id=> 9029614717235204 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 2,
  p_plug_name=> 'Reg_ResumenVenta',
  p_region_name=>'',
  p_escape_on_http_output=>'N',
  p_plug_template=> 9019022671128585+ wwv_flow_api.g_id_offset,
  p_plug_display_sequence=> 10,
  p_plug_new_grid         => false,
  p_plug_new_grid_row     => true,
  p_plug_new_grid_column  => true,
...
a1:=a1||'  SUBSTR(t1.f2_emissao,7,2) || ''/'' || SUBSTR(t1.f2_emissao,5,2)  || ''/'' ||  SUBSTR(t1.f2_emissao,1,4) as EMISION,'||unistr('\000a')||
'  t1.f2_vend1 as "COD.VENDEDOR",'||unistr('\000a')||
'  UPPER(t5.a3_nome) as "NOMBRE VENDEDOR",'||unistr('\000a')||
'  TRIM(TO_CHAR(t1.f2_txmoeda * t.d2_valimp1,''999999999990D99'',''nls_numeric_characters = '''',.'''''')) as "IVA $",'||unistr('\000a')||
'  t.d2_alqimp1 as "IVA %",'||unistr('\000a')||
...
a1:=a1||'ls_numeric_characters = '''',.'''''')) as "TASA CAMBIO",'||unistr('\000a')||
'  TRIM(TO_CHAR(t1.f2_txmoeda * (t.d2_total - t.d2_valimp1),''999999999990D99'',''nls_numeric_characters = '''',.'''''')) as "VALOR NETO",'||unistr('\000a')||
'  TRIM(TO_CHAR(t.d2_custo1,''999999999990D99'',''nls_numeric_characters = '''',.'''''')) as COSTO,'||unistr('\000a')||
'  t2.c5_num as PEDIDO,'||unistr('\000a')||
'  t2.c5_pedori as "PEDIDO ORIGINAL",'||unistr('\000a')||
...
a1:=a1||'lidacion.sb2010@BDTOTUS1 t4, '||unistr('\000a')||
'  validacion.sa3010@BDTOTUS1 t5'||unistr('\000a')||
'  '||unistr('\000a')||
'where'||unistr('\000a')||
'  t1.f2_filial = t.d2_filial'||unistr('\000a')||
...
wwv_flow_api.create_worksheet(
  p_id=> 9029720015235204+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 2,
  p_region_id=> 9029614717235204+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_worksheet_column(
  p_id => 9029906757235237+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 2,
  p_worksheet_id => 9029720015235204+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 3667626052383799+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 2,
  p_worksheet_id => 9029720015235204+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'NRO.SERIE',
  p_display_order          =>2,
  p_column_identifier      =>'AF',
  p_column_label           =>'Nro.Serie',
  p_report_label           =>'Nro.Serie',
  p_sync_form_label        =>'Y',
  p_display_in_default_rpt =>'Y',
  p_is_sortable            =>'Y',
  p_allow_sorting          =>'Y',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 9035431436744188+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 2,
  p_worksheet_id => 9029720015235204+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'NRO.DOCUMENTO',
  p_display_order          =>3,
  p_column_identifier      =>'AA',
  p_column_label           =>'Nro.Documento',
  p_report_label           =>'Nro.Documento',
  p_sync_form_label        =>'Y',
  p_display_in_default_rpt =>'Y',
  p_is_sortable            =>'Y',
  p_allow_sorting          =>'Y',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 9035532020744188+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 2,
  p_worksheet_id => 9029720015235204+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 9030111855235243+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 2,
  p_worksheet_id => 9029720015235204+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 9030214724235244+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 2,
  p_worksheet_id => 9029720015235204+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 9030310570235244+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 2,
  p_worksheet_id => 9029720015235204+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 3668413063450582+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 2,
  p_worksheet_id => 9029720015235204+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 9030533057235245+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 2,
  p_worksheet_id => 9029720015235204+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 9030617677235245+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 2,
  p_worksheet_id => 9029720015235204+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 9030815843235246+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 2,
  p_worksheet_id => 9029720015235204+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 9035605559744190+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 2,
  p_worksheet_id => 9029720015235204+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'COD.VENDEDOR',
  p_display_order          =>14,
  p_column_identifier      =>'AC',
  p_column_label           =>'Cod.Vendedor',
  p_report_label           =>'Cod.Vendedor',
  p_sync_form_label        =>'Y',
  p_display_in_default_rpt =>'Y',
  p_is_sortable            =>'Y',
  p_allow_sorting          =>'Y',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 3667708207383808+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 2,
  p_worksheet_id => 9029720015235204+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'NOMBRE VENDEDOR',
  p_display_order          =>15,
  p_column_identifier      =>'AG',
  p_column_label           =>'Nombre Vendedor',
  p_report_label           =>'Nombre Vendedor',
  p_sync_form_label        =>'Y',
  p_display_in_default_rpt =>'Y',
  p_is_sortable            =>'Y',
  p_allow_sorting          =>'Y',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 3668515530450583+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 2,
  p_worksheet_id => 9029720015235204+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 9031220932235246+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 2,
  p_worksheet_id => 9029720015235204+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'IVA %',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 9031319603235246+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 2,
  p_worksheet_id => 9029720015235204+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 3668600514450584+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 2,
  p_worksheet_id => 9029720015235204+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'TASA CAMBIO',
  p_display_order          =>19,
  p_column_identifier      =>'AL',
  p_column_label           =>'Tasa Cambio',
  p_report_label           =>'Tasa Cambio',
  p_sync_form_label        =>'Y',
  p_display_in_default_rpt =>'Y',
  p_is_sortable            =>'Y',
  p_allow_sorting          =>'Y',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 3668714311450584+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 2,
  p_worksheet_id => 9029720015235204+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'VALOR NETO',
  p_display_order          =>20,
  p_column_identifier      =>'AM',
  p_column_label           =>'Valor Neto',
  p_report_label           =>'Valor Neto',
  p_sync_form_label        =>'Y',
  p_display_in_default_rpt =>'Y',
  p_is_sortable            =>'Y',
  p_allow_sorting          =>'Y',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 9035823411744195+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 2,
  p_worksheet_id => 9029720015235204+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 9031703881235247+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 2,
  p_worksheet_id => 9029720015235204+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 9031812534235247+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 2,
  p_worksheet_id => 9029720015235204+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'PEDIDO ORIGINAL',
  p_display_order          =>30,
  p_column_identifier      =>'T',
  p_column_label           =>'Pedido Original',
  p_report_label           =>'Pedido Original',
  p_sync_form_label        =>'Y',
  p_display_in_default_rpt =>'Y',
  p_is_sortable            =>'Y',
  p_allow_sorting          =>'Y',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 9031926026235247+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 2,
  p_worksheet_id => 9029720015235204+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'TIPO SALIDA',
  p_display_order          =>31,
  p_column_identifier      =>'U',
  p_column_label           =>'Tipo Salida',
  p_report_label           =>'Tipo Salida',
  p_sync_form_label        =>'Y',
  p_display_in_default_rpt =>'Y',
  p_is_sortable            =>'Y',
  p_allow_sorting          =>'Y',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 9032000641235247+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 2,
  p_worksheet_id => 9029720015235204+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 9032116531235247+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 2,
  p_worksheet_id => 9029720015235204+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 9032215971235247+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 2,
  p_worksheet_id => 9029720015235204+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 9032305601235248+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 2,
  p_worksheet_id => 9029720015235204+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'COSTO UNITARIO',
  p_display_order          =>35,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 3667901473383809+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 2,
  p_worksheet_id => 9029720015235204+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'ULTIMA SALIDA',
  p_display_order          =>39,
  p_column_identifier      =>'AI',
  p_column_label           =>'Ultima Salida',
  p_report_label           =>'Ultima Salida',
  p_sync_form_label        =>'Y',
  p_display_in_default_rpt =>'Y',
  p_is_sortable            =>'Y',
  p_allow_sorting          =>'Y',
...
begin
rc1:=rc1||'SUCURSAL:DESCRIPCION:CANTIDAD:CLIENTE:TIENDA:EMISION:IVA %:MONEDA:PEDIDO:PEDIDO ORIGINAL:TIPO SALIDA:MARCA:LINEA:NRO.DOCUMENTO:TRAZABILIDAD:COD.VENDEDOR:COSTO:NRO.SERIE:NOMBRE VENDEDOR:ULTIMA SALIDA:VALOR TOTAL:IVA $:TASA CAMBIO:VALOR NETO';

wwv_flow_api.create_worksheet_rpt(
  p_id => 9032606883242469+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 2,
  p_worksheet_id => 9029720015235204+wwv_flow_api.g_id_offset,
  p_session_id  => null,
...
wwv_flow_api.create_page_branch(
  p_id=>9029509676224871 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 2,
  ...
  p_branch_when_button_id=>9029014062187790+ wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_item(
  p_id=>9028726750171343 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 2,
  ...
  p_item_sequence=> 10,
  p_item_plug_id => 9028332216128709+wwv_flow_api.g_id_offset,
  ...
  p_field_template=> 9023723755128603+wwv_flow_api.g_id_offset,
  p_is_persistent=> 'Y',
...
begin
wwv_flow_api.create_page_item(
  p_id=>9028913163177640 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 2,
...
begin
wwv_flow_api.create_page_item(
  p_id=>9029014062187790 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 2,
  p_name=>'P2_EJECUTAR',
  p_data_type=> 'VARCHAR',
...
prompt  ...PAGE 4: Prm_ResumenNotaCredito
--
...
'No help is available for this page.'
 ,p_last_updated_by => 'YPSA'
 ,p_last_upd_yyyymmddhh24miss => '20150225124236'
  );
null;
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 3880201613930692 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 4,
  p_plug_name=> 'Breadcrumbs',
  p_region_name=>'',
...
begin
s:=s||'SELECT  '||unistr('\000a')||
'  T.D1_FILIAL AS "SUCURSAL",'||unistr('\000a')||
'  VALIDACION.F_LOCAL1@BDTOTUS1(T.D1_FILIAL) AS "NOM_SUCURSAL",'||unistr('\000a')||
'  ''NCC''AS "TIP_DOCUMENTO",'||unistr('\000a')||
'  T.D1_NFORI AS "NRO. SERIE",'||unistr('\000a')||
'  T.D1_DOC AS "NRO. DOCUMENTO",'||unistr('\000a')||
'  ''**N/C**'' AS "TRAZABILIDAD",'||unistr('\000a')||
'  T.D1_COD AS "PRODUCTO",'||unistr('\000a')||
'  T.D1_DESCRIP AS "DESCRIPCION",'||unistr('\000a')||
'  T.D1_QUANT AS CANTIDAD,'||unistr('\000a')||
'  T.D1_TOTAL AS "PRECIO VENTA",'||unistr('\000a')||
'  T.D1_VALDESC AS "DESCUENTO",'||unistr('\000a')||
'  T.D1_TOTAL - T.D1_VALDESC AS ';

s:=s||'"VALOR TOTAL",'||unistr('\000a')||
'  T.D1_FORNECE AS CLIENTE,'||unistr('\000a')||
'  T.D1_LOJA AS TIENDA,'||unistr('\000a')||
'  ''**N/C**'' AS COD_COND_PAGO,'||unistr('\000a')||
'  ''**N/C**'' AS NOM_COND_PAGO,'||unistr('\000a')||
'  SUBSTR(T.D1_EMISSAO,7,2) || ''/'' || SUBSTR(T.D1_EMISSAO,5,2) || ''/'' || SUBSTR(T.D1_EMISSAO,1,4) AS EMISION,'||unistr('\000a')||
'  T1.F1_VEND1 AS "COD. VENDEDOR",'||unistr('\000a')||
'  VALIDACION.F_VENDEDOR@BDTOTUS1(T1.F1_VEND1) AS "NOMBRE VENDEDOR",'||unistr('\000a')||
'  T.D1_VALIMP1 AS "IVA $",'||unistr('\000a')||
'  T.D1_ALQIMP1 AS "IVA %",'||unistr('\000a')||
'  T1.F1_MO';

s:=s||'EDA AS MONEDA,'||unistr('\000a')||
'  T1.F1_TXMOEDA AS "TASA CAMBIO",'||unistr('\000a')||
'  T.D1_TOTAL - T.D1_VALDESC - T.D1_VALIMP1 AS "VALOR NETO",'||unistr('\000a')||
'  T.D1_CUSTO AS COSTO,'||unistr('\000a')||
'  0 AS PEDIDO,'||unistr('\000a')||
'  0 AS PEDIDO_ORIGINAL,'||unistr('\000a')||
'  T.D1_TES AS "TIPO SALIDA",'||unistr('\000a')||
'  T2.B1_MARCA AS MARCA,'||unistr('\000a')||
'  T2.B1_GRUPO AS LINEA,'||unistr('\000a')||
'  T2.B1_FAMILY AS FAMILIA,'||unistr('\000a')||
'  TRIM(TO_CHAR(t4.b2_cm1,''999999999990D99999999'',''nls_numeric_characters = '''',.'''''')) as "COSTO UNITARIO", '||unistr('\000a')||
'  SUBSTR(t4.b2_usa';

s:=s||'i,7,2) || ''/'' || SUBSTR(t4.b2_usai,5,2) || ''/'' || SUBSTR(t4.b2_usai,1,4)  as "ULTIMA SALIDA"'||unistr('\000a')||
'FROM'||unistr('\000a')||
'  VALIDACION.SD1010@BDTOTUS1 T'||unistr('\000a')||
'INNER JOIN'||unistr('\000a')||
'  VALIDACION.SF1010@BDTOTUS1 T1'||unistr('\000a')||
'  ON T1.F1_FILIAL = T.D1_FILIAL'||unistr('\000a')||
'  AND T1.F1_DOC = T.D1_DOC'||unistr('\000a')||
'  AND T1.F1_SERIE = T.D1_SERIE'||unistr('\000a')||
'  AND T1.F1_FORNECE = T.D1_FORNECE'||unistr('\000a')||
'  AND T1.F1_LOJA = T.D1_LOJA'||unistr('\000a')||
'  AND T1.D_E_L_E_T_ <> ''*'''||unistr('\000a')||
'INNER JOIN'||unistr('\000a')||
'  VALIDACION.SB1010@BDTOTUS1 T2'||unistr('\000a')||
'  ON';

s:=s||' T2.B1_COD = T.D1_COD'||unistr('\000a')||
'  AND T2.D_E_L_E_T_ <> ''*''  '||unistr('\000a')||
'LEFT JOIN'||unistr('\000a')||
'  VALIDACION.SB2010@BDTOTUS1 T4'||unistr('\000a')||
'  ON t4.b2_filial = t.d1_filial'||unistr('\000a')||
'  and t4.b2_local = t.d1_local'||unistr('\000a')||
'  and t4.b2_cod = t.d1_cod'||unistr('\000a')||
'  and t4.d_e_l_e_t_ <> ''*''    '||unistr('\000a')||
'WHERE'||unistr('\000a')||
'  T.D1_ESPECIE = ''NCC'''||unistr('\000a')||
'  AND T.D1_EMISSAO >= :P4_DESDEFECHA'||unistr('\000a')||
'  AND T.D1_EMISSAO <= :P4_HASTAFECHA'||unistr('\000a')||
'  AND T.D_E_L_E_T_ <> ''*'''||unistr('\000a')||
'ORDER BY'||unistr('\000a')||
'  T.D1_FILIAL,'||unistr('\000a')||
'  T.D1_DOC  '||unistr('\000a')||
'';

wwv_flow_api.create_page_plug (
  p_id=> 3881022181930709 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 4,
  p_plug_name=> 'Reg_ResumenNotaCredito',
  p_region_name=>'',
  p_escape_on_http_output=>'N',
  p_plug_template=> 9019022671128585+ wwv_flow_api.g_id_offset,
  p_plug_display_sequence=> 10,
...
a1:=a1||'EDA AS MONEDA,'||unistr('\000a')||
'  T1.F1_TXMOEDA AS "TASA CAMBIO",'||unistr('\000a')||
'  T.D1_TOTAL - T.D1_VALDESC - T.D1_VALIMP1 AS "VALOR NETO",'||unistr('\000a')||
'  T.D1_CUSTO AS COSTO,'||unistr('\000a')||
'  0 AS PEDIDO,'||unistr('\000a')||
...
a1:=a1||'i,7,2) || ''/'' || SUBSTR(t4.b2_usai,5,2) || ''/'' || SUBSTR(t4.b2_usai,1,4)  as "ULTIMA SALIDA"'||unistr('\000a')||
'FROM'||unistr('\000a')||
'  VALIDACION.SD1010@BDTOTUS1 T'||unistr('\000a')||
'INNER JOIN'||unistr('\000a')||
'  VALIDACION.SF1010@BDTOTUS1 T1'||unistr('\000a')||
...
a1:=a1||' T2.B1_COD = T.D1_COD'||unistr('\000a')||
'  AND T2.D_E_L_E_T_ <> ''*''  '||unistr('\000a')||
'LEFT JOIN'||unistr('\000a')||
'  VALIDACION.SB2010@BDTOTUS1 T4'||unistr('\000a')||
'  ON t4.b2_filial = t.d1_filial'||unistr('\000a')||
...
wwv_flow_api.create_worksheet(
  p_id=> 3881201499930713+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 4,
  p_region_id=> 3881022181930709+wwv_flow_api.g_id_offset,
  p_name=> 'Reg_ResumenVenta',
  p_folder_id=> null, 
  p_alias=> '',
  p_report_id_item=> '',
  ...
  p_detail_view_enabled_yn=>'N',
  p_owner=>'JCABRERA',
  p_internal_uid=> 3881201499930713);
end;
/
begin
wwv_flow_api.create_worksheet_column(
  p_id => 3881303585930726+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 4,
  p_worksheet_id => 3881201499930713+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'SUCURSAL',
  p_display_order          =>1,
  p_column_identifier      =>'A',
  p_column_label           =>'Sucursal',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 3881503889930731+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 4,
  p_worksheet_id => 3881201499930713+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'TRAZABILIDAD',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 3882528392930733+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 4,
  p_worksheet_id => 3881201499930713+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'PRODUCTO',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 3882631846930733+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 4,
  p_worksheet_id => 3881201499930713+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'DESCRIPCION',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 3882717702930734+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 4,
  p_worksheet_id => 3881201499930713+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'CANTIDAD',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 3882805745930734+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 4,
  p_worksheet_id => 3881201499930713+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'CLIENTE',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 3882914965930734+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 4,
  p_worksheet_id => 3881201499930713+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'TIENDA',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 3883028452930734+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 4,
  p_worksheet_id => 3881201499930713+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'EMISION',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 3881914150930732+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 4,
  p_worksheet_id => 3881201499930713+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'NOMBRE VENDEDOR',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 3883106666930735+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 4,
  p_worksheet_id => 3881201499930713+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'IVA %',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 3883218522930735+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 4,
  p_worksheet_id => 3881201499930713+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'MONEDA',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 3883530429930735+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 4,
  p_worksheet_id => 3881201499930713+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'TIPO SALIDA',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 3883632552930736+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 4,
  p_worksheet_id => 3881201499930713+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'MARCA',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 3883708818930736+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 4,
  p_worksheet_id => 3881201499930713+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'LINEA',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 3883821992930736+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 4,
  p_worksheet_id => 3881201499930713+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'FAMILIA',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 3883918806930736+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 4,
  p_worksheet_id => 3881201499930713+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'COSTO UNITARIO',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 3882028439930732+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 4,
  p_worksheet_id => 3881201499930713+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'ULTIMA SALIDA',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 3885311676181644+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 4,
  p_worksheet_id => 3881201499930713+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 3885429453181646+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 4,
  p_worksheet_id => 3881201499930713+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 3885511447181646+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 4,
  p_worksheet_id => 3881201499930713+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'NRO. SERIE',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 3885602442181647+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 4,
  p_worksheet_id => 3881201499930713+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'NRO. DOCUMENTO',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 3885727486181647+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 4,
  p_worksheet_id => 3881201499930713+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'PRECIO VENTA',
  p_display_order          =>44,
  p_column_identifier      =>'AN',
  p_column_label           =>'Precio Venta',
  p_report_label           =>'Precio Venta',
  p_sync_form_label        =>'Y',
  p_display_in_default_rpt =>'Y',
  p_is_sortable            =>'Y',
  p_allow_sorting          =>'Y',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 3885815458181647+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 4,
  p_worksheet_id => 3881201499930713+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 3885932306181648+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 4,
  p_worksheet_id => 3881201499930713+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'VALOR TOTAL',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 3886024555181648+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 4,
  p_worksheet_id => 3881201499930713+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'COD_COND_PAGO',
  p_display_order          =>47,
  p_column_identifier      =>'AQ',
  p_column_label           =>'Cod Cond Pago',
  p_report_label           =>'Cod Cond Pago',
  p_sync_form_label        =>'Y',
  p_display_in_default_rpt =>'Y',
  p_is_sortable            =>'Y',
  p_allow_sorting          =>'Y',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 3886113956181648+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 4,
  p_worksheet_id => 3881201499930713+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'NOM_COND_PAGO',
  p_display_order          =>48,
  p_column_identifier      =>'AR',
  p_column_label           =>'Nom Cond Pago',
  p_report_label           =>'Nom Cond Pago',
  p_sync_form_label        =>'Y',
  p_display_in_default_rpt =>'Y',
  p_is_sortable            =>'Y',
  p_allow_sorting          =>'Y',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 3886213413181649+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 4,
  p_worksheet_id => 3881201499930713+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'COD. VENDEDOR',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 3886304235181649+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 4,
  p_worksheet_id => 3881201499930713+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'IVA $',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 3886416718181649+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 4,
  p_worksheet_id => 3881201499930713+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'TASA CAMBIO',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 3886501649181650+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 4,
  p_worksheet_id => 3881201499930713+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'VALOR NETO',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 3886601321181650+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 4,
  p_worksheet_id => 3881201499930713+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'COSTO',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 3886719641181650+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 4,
  p_worksheet_id => 3881201499930713+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'PEDIDO',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 3886815662181651+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 4,
  p_worksheet_id => 3881201499930713+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'PEDIDO_ORIGINAL',
  p_display_order          =>55,
...
declare
    rc1 varchar2(32767) := null;
begin
rc1:=rc1||'SUCURSAL:DESCRIPCION:CANTIDAD:CLIENTE:TIENDA:EMISION:IVA %:TIPO SALIDA:MARCA:LINEA:TRAZABILIDAD:NOMBRE VENDEDOR:ULTIMA SALIDA:NOM_SUCURSAL:TIP_DOCUMENTO:NRO. SERIE:NRO. DOCUMENTO:PRECIO VENTA:DESCUENTO:VALOR TOTAL:COD_COND_PAGO:NOM_COND_PAGO:COD. VENDEDOR:IVA $:TASA CAMBIO:VALOR NETO:COSTO:PEDIDO:PEDIDO_ORIGINAL';

wwv_flow_api.create_worksheet_rpt(
  p_id => 3884032719930737+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 4,
  p_worksheet_id => 3881201499930713+wwv_flow_api.g_id_offset,
  p_session_id  => null,
...
wwv_flow_api.create_page_branch(
  p_id=>3884322934930744 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 4,
  p_branch_name=> 'Brn_ResumenNotaCredito',
  p_branch_action=> 'f?p=&APP_ID.:4:&SESSION.::&DEBUG.::P4_DESDEFECHA,P4_HASTAFECHA:&P4_DESDEFECHA.,&P4_HASTAFECHA.',
  p_branch_point=> 'BEFORE_COMPUTATION',
  p_branch_type=> 'REDIRECT_URL',
  p_branch_when_button_id=>3880801029930708+ wwv_flow_api.g_id_offset,
  p_branch_sequence=> 10,
  p_save_state_before_branch_yn=>'N',
  p_branch_comment=> '');
...
begin
wwv_flow_api.create_page_item(
  p_id=>3880417233930700 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 4,
  ...
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 10,
  p_item_plug_id => 3880201613930692+wwv_flow_api.g_id_offset,
  p_use_cache_before_default=> 'YES',
  p_item_default=> '20140601',
  p_item_default_type=> 'STATIC_TEXT_WITH_SUBSTITUTIONS',
  p_prompt=>'Desde fecha (YYYYMMDD)',
...
begin
wwv_flow_api.create_page_item(
  p_id=>3880612505930707 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 4,
...
begin
wwv_flow_api.create_page_item(
  p_id=>3880801029930708 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 4,
  p_name=>'P4_EJECUTAR',
  p_data_type=> 'VARCHAR',
...
prompt  ...PAGE 5: Prm_ResumenVentaNotaCredito
--
...
wwv_flow_api.create_page (
 ...
 ,p_id => 5
 ,p_user_interface_id => 9025803807128680 + wwv_flow_api.g_id_offset
 ,p_name => 'Prm_ResumenVentaNotaCredito'
 ,p_step_title => 'Prm_ResumenVentaNotaCredito'
 ,p_allow_duplicate_submissions => 'Y'
 ,p_step_sub_title => 'Prm_ResumenVentaNotaCredito'
 ,p_step_sub_title_type => 'TEXT_WITH_SUBSTITUTIONS'
 ,p_first_item => 'AUTO_FIRST_ITEM'
 ,p_include_apex_css_js_yn => 'Y'
 ,p_autocomplete_on_off => 'ON'
...
'No help is available for this page.'
 ,p_last_updated_by => 'YPSA'
 ,p_last_upd_yyyymmddhh24miss => '20150225130050'
  );
null;
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 3889003794263500 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 5,
  p_plug_name=> 'Breadcrumbs',
  p_region_name=>'',
...
'select'||unistr('\000a')||
'  t.d2_filial as SUCURSAL,'||unistr('\000a')||
'  VALIDACION.F_LOCAL1@BDTOTUS1(t.d2_filial) as NOM_SUCURSAL,'||unistr('\000a')||
'  ''1-NF'' AS TIP_DOCUMENTO,'||unistr('\000a')||
'  t.d2_serie as "NRO.SERIE",'||unistr('\000a')||
'  trim(t1.f2_doc) as "NRO.DOCUMENTO",'||unistr('\000a')||
'  trim(t.d2_numseri) as "TRAZABILIDAD",'||unistr('\000a')||
'  trim(t.d2_cod) as PRODUCTO,'||unistr('\000a')||
'  UPPER(t.d2_descri) as DESCRIPCION,'||unistr('\000a')||
'  t.d2_quant as CANTIDAD,'||unistr('\000a')||
'  TRIM(TO_CHAR(t.D2_Prunit,''999999999990D99'',''nls_numeri';

s:=s||'c_characters = '''',.'''''')) as "PRECIO VENTA",'||unistr('\000a')||
'  TRIM(TO_CHAR(t.D2_Descon,''999999999990D99'',''nls_numeric_characters = '''',.'''''')) as "DESCUENTO",'||unistr('\000a')||
'  TRIM(TO_CHAR(t.d2_total * t1.f2_txmoeda,''999999999990D99'',''nls_numeric_characters = '''',.'''''')) as "VALOR TOTAL",'||unistr('\000a')||
'  t1.f2_cliente as CLIENTE,'||unistr('\000a')||
'  (SELECT S2.A1_NOME FROM VALIDACION.SA1010@BDTOTUS1 S2 WHERE S2.A1_LOJA = T1.F2_LOJA AND S2.A1_COD = t1.f2_cliente a';

s:=s||'nd S2.D_E_L_E_T_ <> ''*'') AS NOM_CLIENTE,'||unistr('\000a')||
'  t1.f2_loja as TIENDA,'||unistr('\000a')||
'  T1.F2_COND as COD_COND_PAGO,'||unistr('\000a')||
'  (SELECT S1.E4_DESCRI FROM VALIDACION.SE4010@BDTOTUS1 S1 WHERE S1.E4_FILIAL = T.D2_FILIAL AND S1.E4_CODIGO = T1.F2_COND AND S1.D_E_L_E_T_ <> ''*'') as NOM_COND_PAGO,'||unistr('\000a')||
'  SUBSTR(t1.f2_emissao,7,2) || ''/'' || SUBSTR(t1.f2_emissao,5,2)  || ''/'' ||  SUBSTR(t1.f2_emissao,1,4) as EMISION,'||unistr('\000a')||
'  t1.f2_vend1 as "COD.VEN';

s:=s||'DEDOR",'||unistr('\000a')||
'  UPPER(t5.a3_nome) as "NOMBRE VENDEDOR",'||unistr('\000a')||
'  TRIM(TO_CHAR(t1.f2_txmoeda * t.d2_valimp1,''999999999990D99'',''nls_numeric_characters = '''',.'''''')) as "IVA $",'||unistr('\000a')||
'  t.d2_alqimp1 as "IVA %",'||unistr('\000a')||
'  t1.f2_moeda as MONEDA,'||unistr('\000a')||
'  TRIM(TO_CHAR(t1.f2_txmoeda,''999999999990D99'',''nls_numeric_characters = '''',.'''''')) as "TASA CAMBIO",'||unistr('\000a')||
'  TRIM(TO_CHAR(t1.f2_txmoeda * (t.d2_total - t.d2_valimp1),''999999999990D99'',''nls_numer';

s:=s||'ic_characters = '''',.'''''')) as "VALOR NETO",'||unistr('\000a')||
'  TRIM(TO_CHAR(t.d2_custo1,''999999999990D99'',''nls_numeric_characters = '''',.'''''')) as COSTO,'||unistr('\000a')||
'  t2.c5_num as PEDIDO,'||unistr('\000a')||
'  t2.c5_pedori as "PEDIDO ORIGINAL",'||unistr('\000a')||
'  t.d2_tes as "TIPO SALIDA",'||unistr('\000a')||
'  t3.b1_marca as MARCA,'||unistr('\000a')||
'  t3.b1_grupo as LINEA,'||unistr('\000a')||
'  t3.b1_family as FAMILIA,'||unistr('\000a')||
'  TRIM(TO_CHAR(t4.b2_cm1,''999999999990D99999999'',''nls_numeric_characters = '''',.'''''')) as "COSTO UNITARI';
...
'  and t2.d_e_l_e_t_ (+) <> ''*'''||unistr('\000a')||
''||unistr('\000a')||
'  and t3.b1_cod = t.d2_cod'||unistr('\000a')||
'  and t3.d_e_l_e_t_ <> ''*'''||unistr('\000a')||
''||unistr('\000a')||
''||unistr('\000a')||
'  and t4.b2_filial = t.d2_filial'||unistr('\000a')||
...
'  and t5.d_e_l_e_t_ (+) <> ''*'''||unistr('\000a')||
'  '||unistr('\000a')||
'  and t.d2_emissao >= :P5_DESDEFECHA'||unistr('\000a')||
'  and t.d2_emissao <= :P5_HASTAFECHA'||unistr('\000a')||
'  and t.d2_especie = ''NF'''||unistr('\000a')||
'  and t.d_e_l_e_t_ <> ''*''  '||unistr('\000a')||
'  and t.r_e_c_d_e_l_ = 0'||unistr('\000a')||
'--- --------------------------------------------------------------------  '||unistr('\000a')||
...
'  T.D1_FILIAL AS "SUCURSAL",'||unistr('\000a')||
'  VALIDACION.F_LOCAL1@BDTOTUS1(T.D1_FILIAL) AS "NOM_SUCURSAL",'||unistr('\000a')||
'  ''2-NCC''AS "TIP_DOCUMENTO",'||unistr('\000a')||
'  T.D1_NFORI AS "NRO. SERIE",'||unistr('\000a')||
'  T.D1_DOC AS "NRO. DOCUMENTO",'||unistr('\000a')||
'  ''**N/C**'' AS "TRAZABILIDAD",'||unistr('\000a')||
'  T.D1_COD AS "PRODUCTO",'||unistr('\000a')||
'  T.D1_DESCRIP AS "DESCRIPCION",'||unistr('\000a')||
'  T.D1_QUANT AS CANTIDAD,'||unistr('\000a')||
'  TRIM(TO_CHAR(T.D1_TOTAL * -1,''999999999990D99'',''nls_numeric_characters = '''',.'''''')) as "PRECIO VE';

s:=s||'NTA",  '||unistr('\000a')||
'  TRIM(TO_CHAR(T.D1_VALDESC * -1,''999999999990D99'',''nls_numeric_characters = '''',.'''''')) as "DESCUENTO",'||unistr('\000a')||
'  TRIM(TO_CHAR((T.D1_TOTAL - T.D1_VALDESC) * -1,''999999999990D99'',''nls_numeric_characters = '''',.'''''')) as "VALOR TOTAL",'||unistr('\000a')||
'  T.D1_FORNECE AS CLIENTE,'||unistr('\000a')||
'  (SELECT S2.A1_NOME FROM VALIDACION.SA1010@BDTOTUS1 S2 WHERE S2.A1_LOJA = T.D1_LOJA AND S2.A1_COD = T.D1_FORNECE AND S2.D_E_L_E_T_ <> ''*'') AS';

s:=s||' NOM_CLIENTE,'||unistr('\000a')||
'  T.D1_LOJA AS TIENDA,'||unistr('\000a')||
'  ''**N/C**'' AS COD_COND_PAGO,'||unistr('\000a')||
'  ''**N/C**'' AS NOM_COND_PAGO,'||unistr('\000a')||
'  SUBSTR(T.D1_EMISSAO,7,2) || ''/'' || SUBSTR(T.D1_EMISSAO,5,2) || ''/'' || SUBSTR(T.D1_EMISSAO,1,4) AS EMISION,'||unistr('\000a')||
'  T1.F1_VEND1 AS "COD. VENDEDOR",'||unistr('\000a')||
'  VALIDACION.F_VENDEDOR@BDTOTUS1(T1.F1_VEND1) AS "NOMBRE VENDEDOR",'||unistr('\000a')||
'  TRIM(TO_CHAR(T.D1_VALIMP1 * -1,''999999999990D99'',''nls_numeric_characters = '''',.'''''')) as "I';

s:=s||'VA $",'||unistr('\000a')||
'  T.D1_ALQIMP1 AS "IVA %",'||unistr('\000a')||
'  T1.F1_MOEDA AS MONEDA,'||unistr('\000a')||
'  TRIM(TO_CHAR(T1.F1_TXMOEDA * -1,''999999999990D99'',''nls_numeric_characters = '''',.'''''')) as "TASA CAMBIO",'||unistr('\000a')||
'  TRIM(TO_CHAR((T.D1_TOTAL - T.D1_VALDESC - T.D1_VALIMP1) * -1,''999999999990D99'',''nls_numeric_characters = '''',.'''''')) as "VALOR NETO",'||unistr('\000a')||
'  TRIM(TO_CHAR(T.D1_CUSTO * -1,''999999999990D99'',''nls_numeric_characters = '''',.'''''')) as COSTO,'||unistr('\000a')||
'  ''**N';

s:=s||'/C**'' AS PEDIDO,'||unistr('\000a')||
'  ''**N/C**'' AS PEDIDO_ORIGINAL,'||unistr('\000a')||
'  T.D1_TES AS "TIPO SALIDA",'||unistr('\000a')||
'  T2.B1_MARCA AS MARCA,'||unistr('\000a')||
'  T2.B1_GRUPO AS LINEA,'||unistr('\000a')||
'  T2.B1_FAMILY AS FAMILIA,'||unistr('\000a')||
'  TRIM(TO_CHAR(t4.b2_cm1 * -1,''999999999990D99999999'',''nls_numeric_characters = '''',.'''''')) as "COSTO UNITARIO", '||unistr('\000a')||
'  SUBSTR(t4.b2_usai,7,2) || ''/'' || SUBSTR(t4.b2_usai,5,2) || ''/'' || SUBSTR(t4.b2_usai,1,4)  as "ULTIMA SALIDA"'||unistr('\000a')||
'FROM'||unistr('\000a')||
'  VALIDACION.SD1010';

s:=s||'@BDTOTUS1 T'||unistr('\000a')||
'INNER JOIN'||unistr('\000a')||
'  VALIDACION.SF1010@BDTOTUS1 T1'||unistr('\000a')||
'  ON T1.F1_FILIAL = T.D1_FILIAL'||unistr('\000a')||
'  AND T1.F1_DOC = T.D1_DOC'||unistr('\000a')||
...
'INNER JOIN'||unistr('\000a')||
'  VALIDACION.SB1010@BDTOTUS1 T2'||unistr('\000a')||
'  ON T2.B1_COD = T.D1_COD'||unistr('\000a')||
'  AND T2.D_E_L_E_T_ <> ''*''  '||unistr('\000a')||
'LEFT JOIN'||unistr('\000a')||
'  VALIDACION.SB2010@BDTOTUS1 T4'||unistr('\000a')||
'  ON t4.b2_filial = t.d1';

s:=s||'_filial'||unistr('\000a')||
'  and t4.b2_local = t.d1_local'||unistr('\000a')||
'  and t4.b2_cod = t.d1_cod'||unistr('\000a')||
'  and t4.d_e_l_e_t_ <> ''*''    '||unistr('\000a')||
'WHERE'||unistr('\000a')||
'  T.D1_ESPECIE = ''NCC'''||unistr('\000a')||
'  AND T.D1_EMISSAO >= :P5_DESDEFECHA'||unistr('\000a')||
'  AND T.D1_EMISSAO <= :P5_HASTAFECHA'||unistr('\000a')||
'  AND T.D_E_L_E_T_ <> ''*'''||unistr('\000a')||
') X'||unistr('\000a')||
'ORDER BY'||unistr('\000a')||
'  X.SUCURSAL,'||unistr('\000a')||
'  X.TIP_DOCUMENTO,'||unistr('\000a')||
'  X."NRO.DOCUMENTO"';

wwv_flow_api.create_page_plug (
  p_id=> 3889831200263505 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 5,
  p_plug_name=> 'Reg_ResumenVentaNotaCredito',
  p_region_name=>'',
  p_escape_on_http_output=>'N',
  p_plug_template=> 9019022671128585+ wwv_flow_api.g_id_offset,
  p_plug_display_sequence=> 10,
...
a1:=a1||'c_characters = '''',.'''''')) as "PRECIO VENTA",'||unistr('\000a')||
'  TRIM(TO_CHAR(t.D2_Descon,''999999999990D99'',''nls_numeric_characters = '''',.'''''')) as "DESCUENTO",'||unistr('\000a')||
'  TRIM(TO_CHAR(t.d2_total * t1.f2_txmoeda,''999999999990D99'',''nls_numeric_characters = '''',.'''''')) as "VALOR TOTAL",'||unistr('\000a')||
'  t1.f2_cliente as CLIENTE,'||unistr('\000a')||
'  (SELECT S2.A1_NOME FROM VALIDACION.SA1010@BDTOTUS1 S2 WHERE S2.A1_LOJA = T1.F2_LOJA AND S2.A1_COD = t1.f2_cliente a';

a1:=a1||'nd S2.D_E_L_E_T_ <> ''*'') AS NOM_CLIENTE,'||unistr('\000a')||
'  t1.f2_loja as TIENDA,'||unistr('\000a')||
'  T1.F2_COND as COD_COND_PAGO,'||unistr('\000a')||
'  (SELECT S1.E4_DESCRI FROM VALIDACION.SE4010@BDTOTUS1 S1 WHERE S1.E4_FILIAL = T.D2_FILIAL AND S1.E4_CODIGO = T1.F2_COND AND S1.D_E_L_E_T_ <> ''*'') as NOM_COND_PAGO,'||unistr('\000a')||
'  SUBSTR(t1.f2_emissao,7,2) || ''/'' || SUBSTR(t1.f2_emissao,5,2)  || ''/'' ||  SUBSTR(t1.f2_emissao,1,4) as EMISION,'||unistr('\000a')||
...
a1:=a1||'ic_characters = '''',.'''''')) as "VALOR NETO",'||unistr('\000a')||
'  TRIM(TO_CHAR(t.d2_custo1,''999999999990D99'',''nls_numeric_characters = '''',.'''''')) as COSTO,'||unistr('\000a')||
'  t2.c5_num as PEDIDO,'||unistr('\000a')||
'  t2.c5_pedori as "PEDIDO ORIGINAL",'||unistr('\000a')||
'  t.d2_tes as "TIPO SALIDA",'||unistr('\000a')||
...
a1:=a1||'ie = t.d2_serie'||unistr('\000a')||
'  and t1.f2_cliente = t.d2_cliente'||unistr('\000a')||
'  and t1.f2_loja = t.d2_loja'||unistr('\000a')||
'  and t1.d_e_l_e_t_ <> ''*'''||unistr('\000a')||
'  and t1.r_e_c_d_e_l_ = 0'||unistr('\000a')||
...
a1:=a1||'NTA",  '||unistr('\000a')||
'  TRIM(TO_CHAR(T.D1_VALDESC * -1,''999999999990D99'',''nls_numeric_characters = '''',.'''''')) as "DESCUENTO",'||unistr('\000a')||
'  TRIM(TO_CHAR((T.D1_TOTAL - T.D1_VALDESC) * -1,''999999999990D99'',''nls_numeric_characters = '''',.'''''')) as "VALOR TOTAL",'||unistr('\000a')||
'  T.D1_FORNECE AS CLIENTE,'||unistr('\000a')||
'  (SELECT S2.A1_NOME FROM VALIDACION.SA1010@BDTOTUS1 S2 WHERE S2.A1_LOJA = T.D1_LOJA AND S2.A1_COD = T.D1_FORNECE AND S2.D_E_L_E_T_ <> ''*'') AS';

a1:=a1||' NOM_CLIENTE,'||unistr('\000a')||
'  T.D1_LOJA AS TIENDA,'||unistr('\000a')||
'  ''**N/C**'' AS COD_COND_PAGO,'||unistr('\000a')||
'  ''**N/C**'' AS NOM_COND_PAGO,'||unistr('\000a')||
'  SUBSTR(T.D1_EMISSAO,7,2) || ''/'' || SUBSTR(T.D1_EMISSAO,5,2) || ''/'' || SUBSTR(T.D1_EMISSAO,1,4) AS EMISION,'||unistr('\000a')||
...
wwv_flow_api.create_worksheet(
  p_id=> 3890021032263507+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 5,
  p_region_id=> 3889831200263505+wwv_flow_api.g_id_offset,
  p_name=> 'Reg_ResumenVenta',
  p_folder_id=> null, 
  p_alias=> '',
  p_report_id_item=> '',
  ...
  p_detail_view_enabled_yn=>'N',
  p_owner=>'JCABRERA',
  p_internal_uid=> 3890021032263507);
end;
/
begin
wwv_flow_api.create_worksheet_column(
  p_id => 3890112540263509+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 5,
  p_worksheet_id => 3890021032263507+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'SUCURSAL',
  p_display_order          =>1,
  p_column_identifier      =>'A',
  p_column_label           =>'Sucursal',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 3890213591263510+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 5,
  p_worksheet_id => 3890021032263507+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'TRAZABILIDAD',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 3892113108263517+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 5,
  p_worksheet_id => 3890021032263507+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'PRODUCTO',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 3892207697263517+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 5,
  p_worksheet_id => 3890021032263507+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'DESCRIPCION',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 3892330367263517+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 5,
  p_worksheet_id => 3890021032263507+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'CANTIDAD',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 3892408739263517+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 5,
  p_worksheet_id => 3890021032263507+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'CLIENTE',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 3892522482263517+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 5,
  p_worksheet_id => 3890021032263507+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'TIENDA',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 3892619424263518+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 5,
  p_worksheet_id => 3890021032263507+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'EMISION',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 3890324464263510+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 5,
  p_worksheet_id => 3890021032263507+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'NOMBRE VENDEDOR',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 3892702696263518+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 5,
  p_worksheet_id => 3890021032263507+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'IVA %',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 3892814451263518+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 5,
  p_worksheet_id => 3890021032263507+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'MONEDA',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 3892918077263518+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 5,
  p_worksheet_id => 3890021032263507+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'TIPO SALIDA',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 3893030603263519+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 5,
  p_worksheet_id => 3890021032263507+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'MARCA',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 3893114519263519+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 5,
  p_worksheet_id => 3890021032263507+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'LINEA',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 3893202015263519+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 5,
  p_worksheet_id => 3890021032263507+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'FAMILIA',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 3893321566263519+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 5,
  p_worksheet_id => 3890021032263507+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'COSTO UNITARIO',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 3890419118263510+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 5,
  p_worksheet_id => 3890021032263507+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'ULTIMA SALIDA',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 3890532443263510+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 5,
  p_worksheet_id => 3890021032263507+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'NOM_SUCURSAL',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 3890616182263511+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 5,
  p_worksheet_id => 3890021032263507+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'TIP_DOCUMENTO',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 3891226236263512+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 5,
  p_worksheet_id => 3890021032263507+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'COD_COND_PAGO',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 3891317947263512+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 5,
  p_worksheet_id => 3890021032263507+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'NOM_COND_PAGO',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 3894905120291042+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 5,
  p_worksheet_id => 3890021032263507+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'NRO.SERIE',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 3895006619291042+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 5,
  p_worksheet_id => 3890021032263507+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'NRO.DOCUMENTO',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 3895103305291042+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 5,
  p_worksheet_id => 3890021032263507+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'PRECIO VENTA',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 3895227097291043+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 5,
  p_worksheet_id => 3890021032263507+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'DESCUENTO',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 3895309735291043+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 5,
  p_worksheet_id => 3890021032263507+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'VALOR TOTAL',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 3895409522291043+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 5,
  p_worksheet_id => 3890021032263507+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 3895523599291044+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 5,
  p_worksheet_id => 3890021032263507+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'COD.VENDEDOR',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 3895624179291044+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 5,
  p_worksheet_id => 3890021032263507+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'IVA $',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 3895714551291044+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 5,
  p_worksheet_id => 3890021032263507+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'TASA CAMBIO',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 3895827726291045+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 5,
  p_worksheet_id => 3890021032263507+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'VALOR NETO',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 3895918528291045+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 5,
  p_worksheet_id => 3890021032263507+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'COSTO',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 3896022339291045+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 5,
  p_worksheet_id => 3890021032263507+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'PEDIDO',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 3896122419291046+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 5,
  p_worksheet_id => 3890021032263507+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'PEDIDO ORIGINAL',
...
declare
    rc1 varchar2(32767) := null;
begin
rc1:=rc1||'SUCURSAL:DESCRIPCION:CANTIDAD:CLIENTE:TIENDA:EMISION:IVA %:TIPO SALIDA:MARCA:LINEA:TRAZABILIDAD:NOMBRE VENDEDOR:ULTIMA SALIDA:NOM_SUCURSAL:TIP_DOCUMENTO:COD_COND_PAGO:NOM_COND_PAGO:NRO.SERIE:NRO.DOCUMENTO:PRECIO VENTA:DESCUENTO:VALOR TOTAL:NOM_CLIENTE:COD.VENDEDOR:IVA $:TASA CAMBIO:VALOR NETO:COSTO:PEDIDO:PEDIDO ORIGINAL';

wwv_flow_api.create_worksheet_rpt(
  p_id => 3893428323263520+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 5,
  p_worksheet_id => 3890021032263507+wwv_flow_api.g_id_offset,
  p_session_id  => null,
...
wwv_flow_api.create_page_branch(
  p_id=>3893731087263520 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 5,
  p_branch_name=> 'Brn_ResumenVentaNotaCredito',
  p_branch_action=> 'f?p=&APP_ID.:5:&SESSION.::&DEBUG.::P5_DESDEFECHA,P5_HASTAFECHA:&P5_DESDEFECHA.,&P5_HASTAFECHA.',
  p_branch_point=> 'BEFORE_COMPUTATION',
  p_branch_type=> 'REDIRECT_URL',
  p_branch_when_button_id=>3889417970263504+ wwv_flow_api.g_id_offset,
  p_branch_sequence=> 10,
  p_save_state_before_branch_yn=>'N',
  p_branch_comment=> '');
...
begin
wwv_flow_api.create_page_item(
  p_id=>3889212789263503 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 5,
  ...
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 20,
  p_item_plug_id => 3889003794263500+wwv_flow_api.g_id_offset,
  p_use_cache_before_default=> 'YES',
  p_item_default=> '20140630',
  p_item_default_type=> 'STATIC_TEXT_WITH_SUBSTITUTIONS',
  p_prompt=>'Hasta fecha (YYYYMMDD)',
...
begin
wwv_flow_api.create_page_item(
  p_id=>3889417970263504 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 5,
  p_name=>'P5_EJECUTAR',
  p_data_type=> 'VARCHAR',
...
begin
wwv_flow_api.create_page_item(
  p_id=>3889626712263504 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 5,
...
wwv_flow_api.create_page (
 ...
 ,p_step_template => 9015009965128570 + wwv_flow_api.g_id_offset
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 9026317622128682 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 101,
  p_plug_name=> 'Login',
  p_region_name=>'',
  p_escape_on_http_output=>'N',
  p_plug_template=> 9018128524128583+ wwv_flow_api.g_id_offset,
  p_plug_display_sequence=> 10,
  p_plug_new_grid         => false,
  p_plug_new_grid_row     => true,
  p_plug_new_grid_column  => true,
...
begin
wwv_flow_api.create_page_item(
  p_id=>9026414998128687 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 101,
  ...
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 10,
  p_item_plug_id => 9026317622128682+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_page_item(
  p_id=>9026526605128689 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 101,
...
begin
wwv_flow_api.create_page_item(
  p_id=>9026632696128689 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 101,
  p_name=>'P101_LOGIN',
  p_data_type=> '',
  ...
  p_cMaxlength=> null,
  p_cHeight=> null,
  p_tag_attributes  => 'template:'||to_char(9024123888128605 + wwv_flow_api.g_id_offset),
  p_new_grid=> false,
...
wwv_flow_api.create_page_process(
  p_id     => 9026829880128691 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 101,
...
wwv_flow_api.create_page_process(
  p_id     => 9026730510128689 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 101,
...
wwv_flow_api.create_page_process(
  p_id     => 9027021621128692 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 101,
...
wwv_flow_api.create_page_process(
  p_id     => 9026910248128692 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 101,
  p_process_sequence=> 10,
...
wwv_flow_api.create_list (
  p_id=> 9027506847128696 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_name=> 'Navigation',
  p_list_type=> 'STATIC',
  p_list_query=>'',
...
wwv_flow_api.create_list_item (
  p_id=> 9027630989128699 + wwv_flow_api.g_id_offset,
  p_list_id=> 9027506847128696 + wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_list_item (
  p_id=> 3887519631208363 + wwv_flow_api.g_id_offset,
  p_list_id=> 9027506847128696 + wwv_flow_api.g_id_offset,
  p_list_item_type=> 'LINK',
  p_list_item_status=> 'PUBLIC',
  p_item_displayed=> 'BY_DEFAULT',
...
wwv_flow_api.create_list_item (
  p_id=> 3894009230273902 + wwv_flow_api.g_id_offset,
  p_list_id=> 9027506847128696 + wwv_flow_api.g_id_offset,
  p_list_item_type=> 'LINK',
  p_list_item_status=> 'PUBLIC',
  p_item_displayed=> 'BY_DEFAULT',
...
wwv_flow_api.create_menu (
  p_id=> 9027106612128692 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_name=> ' Breadcrumb');
 
wwv_flow_api.create_menu_option (
  p_id=>9027824878128703 + wwv_flow_api.g_id_offset,
  p_menu_id=>9027106612128692 + wwv_flow_api.g_id_offset,
  p_parent_id=>0,
...
wwv_flow_api.create_menu_option (
  p_id=>9028215482128709 + wwv_flow_api.g_id_offset,
  p_menu_id=>9027106612128692 + wwv_flow_api.g_id_offset,
  p_parent_id=>9027824878128703 + wwv_flow_api.g_id_offset,
...
prompt  ......Page template 9015009965128570
 
begin
 
wwv_flow_api.create_template (
  p_id => 9015009965128570 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_theme_id => 26
 ,p_name => 'Login'
 ,p_is_popup => false
...
prompt  ......Page template 9015106943128574
 
begin
 
wwv_flow_api.create_template (
  p_id => 9015106943128574 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_theme_id => 26
 ,p_name => 'Minimal Page'
 ,p_is_popup => false
...
prompt  ......Page template 9015205355128574
 
begin
 
wwv_flow_api.create_template (
  p_id => 9015205355128574 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_theme_id => 26
...
prompt  ......Page template 9015308653128575
 
begin
 
wwv_flow_api.create_template (
  p_id => 9015308653128575 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_theme_id => 26
...
prompt  ......Page template 9015412323128575
 
begin
 
wwv_flow_api.create_template (
  p_id => 9015412323128575 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_theme_id => 26
...
prompt  ......Page template 9015505361128575
 
begin
 
wwv_flow_api.create_template (
  p_id => 9015505361128575 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_theme_id => 26
...
prompt  ......Page template 9015623880128575
 
begin
 
wwv_flow_api.create_template (
  p_id => 9015623880128575 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_theme_id => 26
...
prompt  ......Page template 9015728668128577
 
begin
 
wwv_flow_api.create_template (
  p_id => 9015728668128577 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_theme_id => 26
...
prompt  ......Page template 9015815211128577
 
begin
 
wwv_flow_api.create_template (
  p_id => 9015815211128577 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_theme_id => 26
...
prompt  ......Page template 9015908473128577
 
begin
 
wwv_flow_api.create_template (
  p_id => 9015908473128577 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_theme_id => 26
...
prompt  ......Page template 9016008374128577
 
begin
 
wwv_flow_api.create_template (
  p_id => 9016008374128577 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_theme_id => 26
...
prompt  ......Page template 9016130392128577
 
begin
 
wwv_flow_api.create_template (
  p_id => 9016130392128577 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_theme_id => 26
...
prompt  ......Page template 9016214425128577
 
begin
 
wwv_flow_api.create_template (
  p_id => 9016214425128577 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_theme_id => 26
...
prompt  ......Page template 9016323108128577
 
begin
 
wwv_flow_api.create_template (
  p_id => 9016323108128577 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_theme_id => 26
 ,p_name => 'Popup'
 ,p_is_popup => false
...
prompt  ......Page template 9016424360128578
 
begin
 
wwv_flow_api.create_template (
  p_id => 9016424360128578 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_theme_id => 26
...
prompt  ......Page template 9016533238128578
 
begin
 
wwv_flow_api.create_template (
  p_id => 9016533238128578 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_theme_id => 26
...
prompt  ......Page template 9016614479128578
 
begin
 
wwv_flow_api.create_template (
  p_id => 9016614479128578 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_theme_id => 26
...
prompt  ......Page template 9016723545128578
 
begin
 
wwv_flow_api.create_template (
  p_id => 9016723545128578 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_theme_id => 26
...
prompt  ......Page template 9016812260128578
 
begin
 
wwv_flow_api.create_template (
  p_id => 9016812260128578 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_theme_id => 26
...
prompt  ......Button Template 9024123888128605
 
begin
 
wwv_flow_api.create_button_templates (
  p_id => 9024123888128605 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
...
prompt  ......Button Template 9024210914128607
 
begin
 
wwv_flow_api.create_button_templates (
  p_id => 9024210914128607 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
...
prompt  ......Button Template 9024326213128607
 
begin
 
wwv_flow_api.create_button_templates (
  p_id => 9024326213128607 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
...
prompt  ......Button Template 9024421761128607
 
begin
 
wwv_flow_api.create_button_templates (
  p_id => 9024421761128607 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
...
prompt  ......Button Template 9024528341128607
 
begin
 
wwv_flow_api.create_button_templates (
  p_id => 9024528341128607 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
...
prompt  ......Button Template 9024630791128607
 
begin
 
wwv_flow_api.create_button_templates (
  p_id => 9024630791128607 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
...
prompt  ......Button Template 9024720890128607
 
begin
 
wwv_flow_api.create_button_templates (
  p_id => 9024720890128607 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
...
prompt  ......Button Template 9024815186128608
 
begin
 
wwv_flow_api.create_button_templates (
  p_id => 9024815186128608 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
...
prompt  ......Button Template 9024927903128608
 
begin
 
wwv_flow_api.create_button_templates (
  p_id => 9024927903128608 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
...
prompt  ......Button Template 9025026229128608
 
begin
 
wwv_flow_api.create_button_templates (
  p_id => 9025026229128608 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
...
prompt  ......region template 9016902015128580
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 9016902015128580 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
...
prompt  ......region template 9017016972128582
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 9017016972128582 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
...
prompt  ......region template 9017133177128582
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 9017133177128582 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
...
prompt  ......region template 9017205029128582
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 9017205029128582 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
...
prompt  ......region template 9017305421128583
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 9017305421128583 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
...
prompt  ......region template 9017401333128583
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 9017401333128583 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
...
prompt  ......region template 9017531901128583
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 9017531901128583 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
...
prompt  ......region template 9017622287128583
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 9017622287128583 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
'<section class="uButtonRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||unistr('\000a')||
...
prompt  ......region template 9017705187128583
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 9017705187128583 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
...
prompt  ......region template 9017823912128583
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 9017823912128583 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||unistr('\000a')||
...
prompt  ......region template 9017907691128583
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 9017907691128583 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
...
prompt  ......region template 9018004441128583
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 9018004441128583 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
...
prompt  ......region template 9018128524128583
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 9018128524128583 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||unistr('\000a')||
...
prompt  ......region template 9018220671128583
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 9018220671128583 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
...
prompt  ......region template 9018328473128583
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 9018328473128583 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
...
prompt  ......region template 9018402869128584
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 9018402869128584 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
'<section class="uRegion uBorderlessRegion uHideShowRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||unistr('\000a')||
...
prompt  ......region template 9018518327128584
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 9018518327128584 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
...
prompt  ......region template 9018629281128584
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 9018629281128584 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
...
prompt  ......region template 9018730149128585
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 9018730149128585 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
...
prompt  ......region template 9018806660128585
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 9018806660128585 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||unistr('\000a')||
...
prompt  ......region template 9018915474128585
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 9018915474128585 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
...
prompt  ......region template 9019022671128585
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 9019022671128585 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
...
prompt  ......region template 9019116085128585
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 9019116085128585 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
...
prompt  ......region template 9019215160128585
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 9019215160128585 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
...
prompt  ......region template 9019333222128586
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 9019333222128586 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||unistr('\000a')||
...
prompt  ......region template 9019404269128586
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 9019404269128586 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||unistr('\000a')||
...
prompt  ......region template 9019503468128586
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 9019503468128586 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
...
prompt  ......region template 9019631752128586
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 9019631752128586 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
'<section class="uRegion uWhiteRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||unistr('\000a')||
...
prompt  ......region template 9019715891128586
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 9019715891128586 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||unistr('\000a')||
...
prompt  ......region template 9019815760128586
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 9019815760128586 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
...
prompt  ......region template 9019918637128586
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 9019918637128586 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||unistr('\000a')||
...
prompt  ......region template 9020031067128588
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 9020031067128588 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
'<section class="uRegion uWhiteRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||unistr('\000a')||
...
prompt  ......region template 9020128268128588
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 9020128268128588 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
...
prompt  ......region template 9020219463128588
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 9020219463128588 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||unistr('\000a')||
...
prompt  ......region template 9020301075128588
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 9020301075128588 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||unistr('\000a')||
...
prompt  ......region template 9020401007128588
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 9020401007128588 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
...
prompt  ......list template 9021600784128595
...
wwv_flow_api.create_list_template (
  p_id=>9021600784128595 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
...
prompt  ......list template 9021717685128599
...
wwv_flow_api.create_list_template (
  p_id=>9021717685128599 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 9021807967128599
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>9021807967128599 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 9021924803128599
...
wwv_flow_api.create_list_template (
  p_id=>9021924803128599 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 9022018226128599
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>9022018226128599 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 9022132667128599
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>9022132667128599 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 9022231998128599
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>9022231998128599 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 9022314048128599
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>9022314048128599 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 9022431136128599
...
wwv_flow_api.create_list_template (
  p_id=>9022431136128599 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 9022513398128600
...
wwv_flow_api.create_list_template (
  p_id=>9022513398128600 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 9022607463128600
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>9022607463128600 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 9022707802128600
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>9022707802128600 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 9022828626128600
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>9022828626128600 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 9022907025128600
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>9022907025128600 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 9023005793128600
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>9023005793128600 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 9023118670128600
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>9023118670128600 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 9023205966128600
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>9023205966128600 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 9023316265128600
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>9023316265128600 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 9023412238128600
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>9023412238128600 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......report template 9020519349128591
...
wwv_flow_api.create_row_template (
  p_id=> 9020519349128591 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 9020627052128594
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 9020627052128594 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 9020716465128594
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 9020716465128594 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 9020813513128594
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 9020813513128594 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 9020927738128594
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 9020927738128594 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 9021010732128594
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 9021010732128594 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 9021115910128594
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 9021115910128594 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 9021232226128594
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 9021232226128594 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 9021308498128594
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 9021308498128594 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 9021401365128594
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 9021401365128594 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 9021500484128594
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 9021500484128594 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......label template 9023520754128602
 
begin
 
begin
wwv_flow_api.create_field_template (
  p_id=> 9023520754128602 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......label template 9023627608128603
 
begin
 
begin
wwv_flow_api.create_field_template (
  p_id=> 9023627608128603 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......label template 9023723755128603
 
begin
 
begin
wwv_flow_api.create_field_template (
  p_id=> 9023723755128603 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......label template 9023805945128603
 
begin
 
begin
wwv_flow_api.create_field_template (
  p_id=> 9023805945128603 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......label template 9023909616128603
 
begin
 
begin
wwv_flow_api.create_field_template (
  p_id=> 9023909616128603 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......label template 9024015830128603
 
begin
 
begin
wwv_flow_api.create_field_template (
  p_id=> 9024015830128603 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......template 9025106977128609
 
begin
 
begin
wwv_flow_api.create_menu_template (
  p_id=> 9025106977128609 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......template 9025215404128610
 
begin
 
begin
wwv_flow_api.create_menu_template (
  p_id=> 9025215404128610 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
--
prompt  ......template 9025625542128614
 
begin
 
begin
wwv_flow_api.create_popup_lov_template (
  p_id=> 9025625542128614 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......template 9025307853128612
 
begin
 
begin
wwv_flow_api.create_calendar_template(
  p_id=> 9025307853128612 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......template 9025411600128614
 
begin
 
begin
wwv_flow_api.create_calendar_template(
  p_id=> 9025411600128614 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......template 9025519634128614
 
begin
 
begin
wwv_flow_api.create_calendar_template(
  p_id=> 9025519634128614 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......theme 9025732287128618
begin
wwv_flow_api.create_theme (
  p_id =>9025732287128618 + wwv_flow_api.g_id_offset,
  p_flow_id =>wwv_flow.g_flow_id,
  p_theme_id  => 26,
  p_theme_name=>'Productivity Applications',
  p_ui_type_name=>'DESKTOP',
  p_is_locked=>false,
  p_default_page_template=>9015908473128577 + wwv_flow_api.g_id_offset,
  p_error_template=>9015412323128575 + wwv_flow_api.g_id_offset,
  p_printer_friendly_template=>9016424360128578 + wwv_flow_api.g_id_offset,
  p_breadcrumb_display_point=>'REGION_POSITION_01',
  p_sidebar_display_point=>'REGION_POSITION_02',
  p_login_template=>9015009965128570 + wwv_flow_api.g_id_offset,
  p_default_button_template=>9024123888128605 + wwv_flow_api.g_id_offset,
  p_default_region_template=>9019404269128586 + wwv_flow_api.g_id_offset,
  p_default_chart_template =>9017823912128583 + wwv_flow_api.g_id_offset,
  p_default_form_template  =>9018128524128583 + wwv_flow_api.g_id_offset,
  p_default_reportr_template   =>9019404269128586 + wwv_flow_api.g_id_offset,
  p_default_tabform_template=>9019404269128586 + wwv_flow_api.g_id_offset,
  p_default_wizard_template=>9020219463128588 + wwv_flow_api.g_id_offset,
  p_default_menur_template=>9017401333128583 + wwv_flow_api.g_id_offset,
  p_default_listr_template=>9017705187128583 + wwv_flow_api.g_id_offset,
  p_default_irr_template=>9018518327128584 + wwv_flow_api.g_id_offset,
  p_default_report_template   =>9021115910128594 + wwv_flow_api.g_id_offset,
  p_default_label_template=>9023723755128603 + wwv_flow_api.g_id_offset,
  p_default_menu_template=>9025106977128609 + wwv_flow_api.g_id_offset,
  p_default_calendar_template=>9025307853128612 + wwv_flow_api.g_id_offset,
  p_default_list_template=>9023205966128600 + wwv_flow_api.g_id_offset,
  p_default_option_label=>9023805945128603 + wwv_flow_api.g_id_offset,
  ...
  p_default_required_label=>9024015830128603 + wwv_flow_api.g_id_offset);
end;
/
...
prompt  ......authentication 9026002780128681
 
begin
 
wwv_flow_api.create_authentication (
  p_id => 9026002780128681 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
...
wwv_flow_api.create_install (
  p_id => 3885025693968704 + wwv_flow_api.g_id_offset,
  p_flow_id => wwv_flow.g_flow_id,
